 ...
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const D=o=>e=>typeof e=="function"?((t,i)=>(customElements.define(t,i),i))(o,e):((t,i)=>{const{kind:r,elements:s}=i;return{kind:r,elements:s,finisher(a){customElements.define(t,a)}}})(o,e);/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
...
`;class Kt extends k{static get styles(){return T`
    ...
    `}render(){return Jt}}customElements.define("ia-icon-close-circle",Kt);var Qt=h`
<svg
  viewBox="0 0 40 40"
  xmlns="http://www.w3.org/2000/svg"
...
`;class si extends k{static get styles(){return T`
  ...
  `;l([f({type:Boolean,reflect:!0})],x.prototype,"ready",void 0);l([f({type:Boolean,reflect:!0})],x.prototype,"showAllPhotos",void 0);l([f({type:String,attribute:!0,reflect:!0})],x.prototype,"baseHost",void 0);l([f({type:Boolean,reflect:!0})],x.prototype,"signedIn",void 0);l([f({type:String,reflect:!0,attribute:!0})],x.prototype,"itemIdentifier",void 0);l([f({type:Object})],x.prototype,"itemMD",void 0);l([f({type:Object})],x.prototype,"linerNotesManifest",void 0);l([f({type:Object})],x.prototype,"bookreader",void 0);l([f({type:Boolean,reflect:!0})],x.prototype,"fullscreenActive",void 0);l([f({type:Boolean})],x.prototype,"reInitBrAtFullscreen",void 0);l([f({type:Boolean,reflect:!0})],x.prototype,"noImageAvailable",void 0);l([f({type:Object})],x.prototype,"lightDomHook",void 0);l([V("button.click-for-photos img")],x.prototype,"coverImage",void 0);x=l([D("iaux-photo-viewer")],x);let Pe=class extends k{render(){return h`
...
`,ai=({samples:o,onClick:e,href:t,selected:i})=>{const r=o?S.iaSamples:S.iaPlayer;return h`
    <a href=${t} @click=${()=>e()}>${ge({label:r,selected:i})}</button>
  `},ni=({samples:o,onClick:e,selected:t})=>{const i=o?S.iaSamples:S.iaPlayer;return h`
    <button @click=${r=>e(r)} class="ia">
      ${ge({label:i,selected:t})}
    </button>
  `},li=({onClick:o,selected:e})=>h`<button
  @click=${t=>o(t)}
  class="ia-beta"
>
  ${kt(e)}
</button>`,di=({onClick:o,selected:e})=>h`<button
  @click=${t=>o(t)}
  class="sp"
>
  ${xt(e)}
</button>`,ci=({onClick:o,href:e,selected:t})=>{const i=`${e}?webamp=default`;return h`
    <a href=${i} @click=${r=>o(r)} class="wa">${St(t)}</button>
  `},ui=({onClick:o,selected:e})=>h`<button
  @click=${t=>o(t)}
  class="yt"
>
  ${At(e)}
...
`;var ve;(function(o){o.postInit="postInit",o.channelChange="channelChange"})(ve||(ve={}));let A=class extends k{constructor(){super(...arguments),this.youtube=!1,this.spotify=!1,this.beta=!1,this.webamp=!0,this.samples=!1,this.backgroundTheme="dark",this.selected=p.ia,this.displayStyle="radio",this.url=""}firstUpdated(){this.dispatchEvent(new CustomEvent(ve.postInit,{detail:{channel:this.selected},composed:!0,bubbles:!0}))}emitChannelChanged(){this.dispatchEvent(new CustomEvent(ve.channelChange,{detail:{channel:this.selected},composed:!0,bubbles:!0}))}iaClicked(){this.selected!==p.ia&&(this.selected=p.ia,this.emitChannelChanged())}betaClicked(){this.selected!==p.beta&&(this.selected=p.beta,this.emitChannelChanged())}spotifyClicked(){this.selected!==p.spotify&&(this.selected=p.spotify,this.emitChannelChanged())}webampClicked(){this.selected!==p.webamp&&(this.selected=p.webamp,this.emitChannelChanged())}youtubeClicked(){this.selected!==p.youtube&&(this.selected=p.youtube,this.emitChannelChanged())}dropdownOptionSelected(e){this.selected=e.id,this.emitChannelChanged(),this.iaDropdown.open=!1}get iaLinkSelector(){const e=this.selected===p.ia?"selected":"";return h`
    ...
    `,ki];l([f({attribute:!0,type:Boolean,reflect:!0})],A.prototype,"youtube",void 0);l([f({attribute:!0,type:Boolean,reflect:!0})],A.prototype,"spotify",void 0);l([f({attribute:!0,type:Boolean,reflect:!0})],A.prototype,"beta",void 0);l([f({attribute:!0,type:Boolean,reflect:!0})],A.prototype,"webamp",void 0);l([f({attribute:!0,type:Boolean,reflect:!0})],A.prototype,"samples",void 0);l([f({attribute:!0,type:String,reflect:!0})],A.prototype,"backgroundTheme",void 0);l([f({type:String,reflect:!0})],A.prototype,"selected",void 0);l([f({type:String,reflect:!0})],A.prototype,"displayStyle",void 0);l([f({type:String})],A.prototype,"url",void 0);l([V("ia-dropdown")],A.prototype,"iaDropdown",void 0);A=l([D("channel-selector")],A);let fe=class extends k{constructor(){super(...arguments),this.iaUrn=""}get spotifyUrl(){return!this.iaUrn||!this.iaUrn.match(/urn:spotify:/g)?"":`https://open.spotify.com/embed/${this.iaUrn.replace(/urn:spotify:/g,"").replace(/:/g,"/")}`}render(){const e=this.spotifyUrl;return e?h`
      <iframe
        id="embed-iframe"
        src="${e}"
        width="100%"
    ...
    `:h`<h3>Invalid Spotify URI: ${this.iaUrn}</h3>`}static get styles(){return[T`
      ...
      `]}};l([f({type:String,attribute:!0,reflect:!0})],fe.prototype,"iaUrn",void 0);l([V("iframe")],fe.prototype,"iframe",void 0);fe=l([D("spotify-player")],fe);let Z=class extends k{constructor(){super(...arguments),this.iaUrn="",this.display=!1,this.baseHost="https://archive.org"}get youTubeUrl(){if(!this.iaUrn||!this.iaUrn.match(/urn:youtube:/g))return"";const t=this.iaUrn.replace(/urn:youtube:/g,"").replace(/:/g,"/"),i=`origin=${this.baseHost}&widgetid=1&autoplay=1&rel=0`;return`https://www.youtube.com/embed/${t}?${i}`}render(){const e=this.youTubeUrl;return e?h`
      <iframe
        id="embed-iframe"
        src="${e}"
        width="100%"
    ...
    `}async albumInfo(){this.errorMsg="";try{const e=await fetch(`https://archive.org/metadata/${this.albumId}`).then(i=>i.json()),t=await fetch(`https://archive.org/services/playlist/${this.albumId}`).then(i=>i.json());this.albumPlaylist=t,this.albumMd=new Re(e),this.album=new Si(e,this.albumPlaylist),window.Album=this.album}catch(e){this.errorMsg=e.message}}formInputSubmit(e){e.preventDefault(),this.albumId=this.input.value}get albumStats(){if(!this.album)return g;const e=this.album.spotifyTracks.reduce((i,r)=>(i.push(Number.isInteger(r?.track)?`${r?.track}`:"n/a"),i),[]).join(", "),t=this.album.youtubeTracks.reduce((i,r)=>(i.push(Number.isInteger(r?.track)?`${r?.track}`:"n/a"),i),[]).join(", ");return h`
    ...
    `}displayTrack(e,t){console.log("Displaying track: ",{track:e,channelType:t}),this.selectedTrack=e}get demoClicks(){return h`
      <section id="demo-clicks">
        ${Ai.map(e=>{const t=this.albumId===e.id;return h`
    ...
    `}async displayLooseImages(){var e;(e=this.photoViewerEl)===null||e===void 0||e.prepareLightDomHook();const t=await ri({images:ne.image_filenames,itemIdentifier:ne.item.identifier,itemTitle:ne.item.title,baseHost:"archive.org"});console.log("####### generateBookReaderManifest",t),this.photoViewerEl.linerNotesManifest=t,this.photoViewerEl.itemMD=t.metadata,this.photoViewerEl.itemIdentifier=t.metadata.identifier}get photoViewer(){var e;let t,i,r;switch(this.photoDisplay){case"noData":i="foo-data-12345-ddd";break;case"linerNotes":this.photoDisplay==="linerNotes"&&(t=Ct,i=(e=t?.metadata)===null||e===void 0?void 0:e.identifier,r=t?.metadata);break}return h`
      <section id="components">
        <div>
          <h3>Various Views</h3>
