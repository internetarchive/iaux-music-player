 ...
 */const ie=window,Ae=ie.ShadowRoot&&(ie.ShadyCSS===void 0||ie.ShadyCSS.nativeShadow)&&"adoptedStyleSheets"in Document.prototype&&"replace"in CSSStyleSheet.prototype,Me=Symbol(),Be=new WeakMap;class Xe{constructor(e,t,i){if(this._$cssResult$=!0,i!==Me)throw Error("CSSResult is not constructable. Use `unsafeCSS` or `css` instead.");this.cssText=e,this.t=t}get styleSheet(){let e=this.o;const t=this.t;if(Ae&&e===void 0){const i=t!==void 0&&t.length===1;i&&(e=Be.get(t)),e===void 0&&((this.o=e=new CSSStyleSheet).replaceSync(this.cssText),i&&Be.set(t,e))}return e}toString(){return this.cssText}}const wt=r=>new Xe(typeof r=="string"?r:r+"",void 0,Me),N=(r,...e)=>{const t=r.length===1?r[0]:e.reduce((i,s,a)=>i+(o=>{if(o._$cssResult$===!0)return o.cssText;if(typeof o=="number")return o;throw Error("Value passed to 'css' function must be a 'css' function result: "+o+". Use 'unsafeCSS' to pass non-literal values, but take care to ensure page security.")})(s)+r[a+1],r[0]);return new Xe(t,r,Me)},bt=(r,e)=>{Ae?r.adoptedStyleSheets=e.map(t=>t instanceof CSSStyleSheet?t:t.styleSheet):e.forEach(t=>{const i=document.createElement("style"),s=ie.litNonce;s!==void 0&&i.setAttribute("nonce",s),i.textContent=t.cssText,r.appendChild(i)})},Ve=Ae?r=>r:r=>r instanceof CSSStyleSheet?(e=>{let t="";for(const i of e.cssRules)t+=i.cssText;return wt(t)})(r):r;/**
 * @license
 ...
 * Copyright 2018 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const Ie=Ee(class extends Te{constructor(r){var e;if(super(r),r.type!==pt.ATTRIBUTE||r.name!=="class"||((e=r.strings)===null||e===void 0?void 0:e.length)>2)throw Error("`classMap()` can only be used in the `class` attribute and must be the only part in the attribute.")}render(r){return" "+Object.keys(r).filter(e=>r[e]).join(" ")+" "}update(r,[e]){var t,i;if(this.nt===void 0){this.nt=new Set,r.strings!==void 0&&(this.st=new Set(r.strings.join(" ").split(/\s/).filter(a=>a!=="")));for(const a in e)e[a]&&!(!((t=this.st)===null||t===void 0)&&t.has(a))&&this.nt.add(a);return this.render(e)}const s=r.element.classList;this.nt.forEach(a=>{a in e||(s.remove(a),this.nt.delete(a))});for(const a in e){const o=!!e[a];o===this.nt.has(a)||((i=this.st)===null||i===void 0?void 0:i.has(a))||(o?(s.add(a),this.nt.add(a)):(s.remove(a),this.nt.delete(a)))}return B}});var h;(function(r){r.ia="ia",r.beta="beta",r.youtube="youtube",r.spotify="spotify",r.webamp="webamp"})(h||(h={}));var $;(function(r){r.iaSamples="Samples",r.iaPlayer="Player",r.beta="Beta",r.spotify="Spotify",r.webamp="Webamp",r.youtube="YouTube"})($||($={}));const M={ia:p`<img
    class="ia"
  ...
  />`},ce=(r=$.iaPlayer,e)=>{const i=Pe({filter:e?"invert(1)":"invert(0)",height:"20px",width:"20px"}),s=Ie({selected:e,"invert-icon-at-hover-selected":e});return p`
...
`,vt=r=>{const t=Pe({filter:r?"invert(1)":"invert(0)",height:"20px",width:"20px"}),i=Ie({selected:r,"invert-icon-at-hover-selected":r});return p`
    <ia-icon-label class=${i}>
...
`,Rt=({samples:r,onClick:e,href:t,selected:i})=>{const s=r?$.iaSamples:$.iaPlayer;return p`
    <a href=${t} @click=${()=>e()}>${ce(s,i)}</button>
  `},Nt=({samples:r,onClick:e,selected:t})=>{const i=r?$.iaSamples:$.iaPlayer;return p`
...
>
  ${mt(e)}
</button>`,Lt=({onClick:r,href:e,selected:t})=>{const i=`${e}?webamp=default`;return p`
    <a href=${i} @click=${s=>r(s)} class="wa">${vt(t)}</button>
  `},Ft=({onClick:r,selected:e})=>p`<button
  @click=${t=>r(t)}
  class="yt"
>
  ${gt(e)}
</button>`,zt=({samples:r,onClick:e,href:t,selectedOption:i})=>({url:t,selectedHandler:a=>{e(a)},label:ce(r?$.iaSamples:$.iaPlayer,i===h.ia),id:h.ia}),jt=({samples:r,onClick:e,selectedOption:t})=>({selectedHandler:s=>{e(s)},label:ce(r?$.iaSamples:$.iaPlayer,t===h.ia),id:h.ia}),qt=({onClick:r,selectedOption:e})=>({selectedHandler:i=>{r(i)},label:ft(e===h.beta),id:h.beta}),Wt=({onClick:r,selectedOption:e})=>({selectedHandler:i=>{r(i)},label:mt(e===h.spotify),id:h.spotify}),Yt=({href:r,onClick:e,selectedOption:t})=>{const i=s=>{e(s)};return{url:`${r}?webamp=default`,selectedHandler:i,label:vt(t===h.webamp),id:h.webamp}},Jt=({onClick:r,selectedOption:e})=>({selectedHandler:i=>{r(i)},label:gt(e===h.youtube),id:h.youtube}),Kt=r=>{const{spotify:e,beta:t,youtube:i,selectedOption:s}=r;return[s===h.webamp?zt(r):jt(r),t?qt(r):null,e?Wt(r):null,i?Jt(r):null,Yt(r)].filter(Boolean)};/**
 * @license
 ...
 */const Xt=Ee(class extends Te{constructor(r){super(r),this.et=new WeakMap}render(r){return[r]}update(r,[e]){if(te(this.it)&&(!te(e)||this.it.strings!==e.strings)){const t=Qe(r).pop();let i=this.et.get(this.it.strings);if(i===void 0){const s=document.createDocumentFragment();i=at(g,s),i.setConnected(!1),this.et.set(this.it.strings,i)}Ge(i,[t]),Ze(i,void 0,t)}if(te(e)){if(!te(this.it)||this.it.strings!==e.strings){const t=this.et.get(e.strings);if(t!==void 0){const i=Qe(t).pop();Qt(r),Ze(r,void 0,i),Ge(r,[i])}}this.it=e}else this.it=void 0;return this.render(e)}});let P=class extends C{constructor(){super(...arguments),this.open=!1,this.displayCaret=!1,this.selectedOption="",this.options=[],this.optionGroup="options",this.optionSelected=()=>{}}renderOption(e){const{label:t,url:i=void 0,id:s}=e;let a;const o=this.selectedOption===s?"selected":"";return i?a=p`<a
      ...
      >
        ${t}
      </button>`,p`<li class=${o}>${a}</li>`}optionClicked(e){this.selectedOption=e.id,this.dispatchEvent(new CustomEvent("optionSelected",{detail:{option:e}})),e.selectedHandler&&(e==null||e.selectedHandler(e))}toggleOptions(){this.open=!this.open}get caret(){return this.open?this.caretUp:this.caretDown}get dropdownState(){return this.open?"open":"closed"}get caretUp(){return Fe`<svg class="caret-up-svg" viewBox="0 0 8 4" xmlns="http://www.w3.org/2000/svg">
    <path d="m6.7226499 3.51689722c.22976435.15317623.54019902.0910893.69337525-.13867505.13615665-.20423497.10222882-.47220946-.06836249-.63681849l-.07031256-.05655675-3.2773501-2.18490007-3.2773501 2.18490007c-.22976434.15317623-.29185128.4636109-.13867505.69337524.13615665.20423498.39656688.27598409.61412572.18182636l.07924953-.04315131 2.7226499-1.81402514z"
      fill=""></path>
  </svg>`}get caretDown(){return Fe`<svg class="caret-down-svg" viewBox="0 0 8 4" xmlns="http://www.w3.org/2000/svg">
...
`;var le;(function(r){r.postInit="postInit",r.channelChange="channelChange"})(le||(le={}));let S=class extends C{constructor(){super(...arguments),this.youtube=!1,this.spotify=!1,this.beta=!1,this.webamp=!0,this.samples=!1,this.backgroundTheme="dark",this.selected=h.ia,this.displayStyle="radio",this.url=""}firstUpdated(){this.dispatchEvent(new CustomEvent(le.postInit,{detail:{channel:this.selected},composed:!0,bubbles:!0}))}emitChannelChanged(){this.dispatchEvent(new CustomEvent(le.channelChange,{detail:{channel:this.selected},composed:!0,bubbles:!0}))}iaClicked(){this.selected!==h.ia&&(this.selected=h.ia,this.emitChannelChanged())}betaClicked(){this.selected!==h.beta&&(this.selected=h.beta,this.emitChannelChanged())}spotifyClicked(){this.selected!==h.spotify&&(this.selected=h.spotify,this.emitChannelChanged())}webampClicked(){this.selected!==h.webamp&&(this.selected=h.webamp,this.emitChannelChanged())}youtubeClicked(){this.selected!==h.youtube&&(this.selected=h.youtube,this.emitChannelChanged())}dropdownOptionSelected(e){this.selected=e.id,this.emitChannelChanged(),this.iaDropdown.open=!1}get iaLinkSelector(){const e=this.selected===h.ia?"selected":"";return p`
    ...
    `}get webampSelector(){const e=this.selected===h.webamp?"selected":"";return p`
      <li class=${e}>
        ${Lt({href:this.url||window.location.href,selected:this.selected===h.webamp,onClick:()=>this.webampClicked()})}
      </li>
    `}get youtubeSelector(){const e=this.selected===h.youtube?"selected":"";return p`
      <li class=${e}>
        ${Ft({selected:this.selected===h.youtube,onClick:()=>this.youtubeClicked()})}
      </li>
    ...
    `,ei];l([v({attribute:!0,type:Boolean,reflect:!0})],S.prototype,"youtube",void 0);l([v({attribute:!0,type:Boolean,reflect:!0})],S.prototype,"spotify",void 0);l([v({attribute:!0,type:Boolean,reflect:!0})],S.prototype,"beta",void 0);l([v({attribute:!0,type:Boolean,reflect:!0})],S.prototype,"webamp",void 0);l([v({attribute:!0,type:Boolean,reflect:!0})],S.prototype,"samples",void 0);l([v({attribute:!0,type:String,reflect:!0})],S.prototype,"backgroundTheme",void 0);l([v({type:String,reflect:!0})],S.prototype,"selected",void 0);l([v({type:String,reflect:!0})],S.prototype,"displayStyle",void 0);l([v({type:String})],S.prototype,"url",void 0);l([de("ia-dropdown")],S.prototype,"iaDropdown",void 0);S=l([q("channel-selector")],S);let G=class extends C{constructor(){super(...arguments),this.iaSpotifyUrn="",this.display=!1}get spotifyUrl(){return!this.iaSpotifyUrn||!this.iaSpotifyUrn.match(/urn:spotify:/g)?"":`https://open.spotify.com/embed/${this.iaSpotifyUrn.replace(/urn:spotify:/g,"").replace(/:/g,"/")}`}render(){const e=this.spotifyUrl;return e?p`
      <iframe
        id="embed-iframe"
        src="${e}"
        width="100%"
    ...
    `:p`<h3>Invalid Spotify URI: ${this.iaSpotifyUrn}</h3>`}static get styles(){return[N`
      ...
      `]}};l([v({type:String,reflect:!0})],G.prototype,"iaSpotifyUrn",void 0);l([v({type:Boolean,reflect:!0})],G.prototype,"display",void 0);l([de("iframe")],G.prototype,"iframe",void 0);G=l([q("spotify-player")],G);let z=class extends C{constructor(){super(...arguments),this.iaYouTubeUrn="",this.display=!1,this.baseHost="https://archive.org"}get youTubeUrl(){if(!this.iaYouTubeUrn||!this.iaYouTubeUrn.match(/urn:youtube:/g))return"";const t=this.iaYouTubeUrn.replace(/urn:youtube:/g,"").replace(/:/g,"/"),i=`origin=${this.baseHost}&widgetid=1&autoplay=1&rel=0`;return`https://www.youtube.com/embed/${t}?${i}`}render(){const e=this.youTubeUrl;return e?p`
      <iframe
        id="embed-iframe"
        src="${e}"
        width="100%"
    ...
    `}get channelSelectors(){const e=`${location.origin}/demo`;return p`
  ...
  `;l([v({type:String,reflect:!0})],_.prototype,"viewToShow",void 0);l([v({type:String})],_.prototype,"selectedByDropdown",void 0);l([v({type:String})],_.prototype,"errorMsg",void 0);l([v({type:String})],_.prototype,"selectedByDropdownOnload",void 0);l([v({type:String})],_.prototype,"selectedByRadio",void 0);l([v({type:String})],_.prototype,"selectedByRadioOnload",void 0);l([v({type:String})],_.prototype,"albumId",void 0);l([v({type:String})],_.prototype,"bgColor",void 0);l([v({type:Object,attribute:!1})],_.prototype,"albumMd",void 0);l([v({type:Object,attribute:!1})],_.prototype,"albumPlaylist",void 0);l([v({type:Object,attribute:!1})],_.prototype,"album",void 0);l([v({type:String})],_.prototype,"componentToShow",void 0);l([de("input#md-search")],_.prototype,"input",void 0);_=l([q("app-root")],_);
