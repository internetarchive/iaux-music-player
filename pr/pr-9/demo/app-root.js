...
>
  ${gt(e)}
</button>`,zt=({samples:r,onClick:e,href:t,selectedOption:i})=>({url:t,selectedHandler:a=>{e(a)},label:ce(r?$.iaSamples:$.iaPlayer,i===h.ia),id:h.ia}),jt=({samples:r,onClick:e,selectedOption:t})=>({selectedHandler:s=>{e(s)},label:ce(r?$.iaSamples:$.iaPlayer,t===h.ia),id:h.ia}),qt=({onClick:r,selectedOption:e})=>({selectedHandler:i=>{r(i)},label:ft(e===h.beta),id:h.beta}),Wt=({onClick:r,selectedOption:e})=>({selectedHandler:i=>{r(i)},label:vt(e===h.spotify),id:h.spotify}),Yt=({href:r,onClick:e,selectedOption:t})=>{const i=s=>{e(s)};return{url:`${r}?webamp=default`,selectedHandler:i,label:mt(t===h.webamp),id:h.webamp}},Jt=({onClick:r,selectedOption:e})=>({selectedHandler:i=>{r(i)},label:gt(e===h.youtube),id:h.youtube}),Kt=r=>{const{spotify:e,beta:t,youtube:i,selectedOption:s}=r;return[s===h.webamp?zt(r):jt(r),t?qt(r):null,e?Wt(r):null,i?Jt(r):null,Yt(r)].filter(Boolean)};/**
 * @license
...
`;var le;(function(r){r.postInit="postInit",r.channelChange="channelChange"})(le||(le={}));let S=class extends C{constructor(){super(...arguments),this.youtube=!1,this.spotify=!1,this.beta=!1,this.webamp=!0,this.samples=!1,this.dropdownLabelTheme="dark",this.selected=h.ia,this.displayStyle="radio",this.url=""}firstUpdated(){this.dispatchEvent(new CustomEvent(le.postInit,{detail:{channel:this.selected},composed:!0,bubbles:!0}))}emitChannelChanged(){this.dispatchEvent(new CustomEvent(le.channelChange,{detail:{channel:this.selected},composed:!0,bubbles:!0}))}iaClicked(){this.selected!==h.ia&&(this.selected=h.ia,this.emitChannelChanged())}betaClicked(){this.selected!==h.beta&&(this.selected=h.beta,this.emitChannelChanged())}spotifyClicked(){this.selected!==h.spotify&&(this.selected=h.spotify,this.emitChannelChanged())}webampClicked(){this.selected!==h.webamp&&(this.selected=h.webamp,this.emitChannelChanged())}youtubeClicked(){this.selected!==h.youtube&&(this.selected=h.youtube,this.emitChannelChanged())}dropdownOptionSelected(e){this.selected=e.id,this.emitChannelChanged(),this.iaDropdown.open=!1}get iaLinkSelector(){const e=this.selected===h.ia?"selected":"";return p`
  ...
  `;l([m({type:String,reflect:!0})],_.prototype,"viewToShow",void 0);l([m({type:String})],_.prototype,"selectedByDropdown",void 0);l([m({type:String})],_.prototype,"errorMsg",void 0);l([m({type:String})],_.prototype,"selectedByDropdownOnload",void 0);l([m({type:String})],_.prototype,"selectedByRadio",void 0);l([m({type:String})],_.prototype,"selectedByRadioOnload",void 0);l([m({type:String})],_.prototype,"albumId",void 0);l([m({type:String})],_.prototype,"bgColor",void 0);l([m({type:Object,attribute:!1})],_.prototype,"albumMd",void 0);l([m({type:Object,attribute:!1})],_.prototype,"albumPlaylist",void 0);l([m({type:Object,attribute:!1})],_.prototype,"album",void 0);l([de("input#md-search")],_.prototype,"input",void 0);_=l([q("app-root")],_);
