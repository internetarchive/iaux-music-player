...
`;class ri extends k{static get styles(){return M`
  ...
  `;n([g({type:Boolean,reflect:!0})],x.prototype,"showAllPhotos",void 0);n([g({type:String,attribute:!0,reflect:!0})],x.prototype,"baseHost",void 0);n([g({type:Boolean,reflect:!0})],x.prototype,"signedIn",void 0);n([g({type:String,reflect:!0,attribute:!0})],x.prototype,"itemIdentifier",void 0);n([g({type:Object})],x.prototype,"itemMD",void 0);n([g({type:Object})],x.prototype,"linerNotesManifest",void 0);n([g({type:Object})],x.prototype,"bookreader",void 0);n([g({type:Boolean,reflect:!0})],x.prototype,"fullscreenActive",void 0);n([g({type:Boolean})],x.prototype,"reInitBrAtFullscreen",void 0);n([g({type:Boolean,reflect:!0})],x.prototype,"noImageAvailable",void 0);n([g({type:Object})],x.prototype,"lightDomHook",void 0);n([Z("button.click-for-photos img")],x.prototype,"coverImage",void 0);x=n([O("iaux-photo-viewer")],x);let Ee=class extends k{render(){return u`
...
>
  ${St(e)}
</button>`,ci=({samples:r,onClick:e,href:t,selectedOption:i})=>({url:t,selectedHandler:s=>{e(s)},label:fe({label:r?S.iaSamples:S.iaPlayer,selected:i===v.ia}),id:v.ia}),ui=({samples:r,onClick:e,selectedOption:t})=>({selectedHandler:o=>{e(o)},label:fe({label:r?S.iaSamples:S.iaPlayer,selected:t===v.ia}),id:v.ia}),hi=({onClick:r,selectedOption:e})=>({selectedHandler:i=>{r(i)},label:_t(e===v.beta),id:v.beta}),pi=({onClick:r,selectedOption:e})=>({selectedHandler:i=>{r(i)},label:kt(e===v.spotify),id:v.spotify}),vi=({href:r,onClick:e,selectedOption:t})=>{const i=o=>{e(o)};return{url:`${r}?webamp=default`,selectedHandler:i,label:xt(t===v.webamp),id:v.webamp}},gi=({onClick:r,selectedOption:e})=>({selectedHandler:i=>{r(i)},label:St(e===v.youtube),id:v.youtube}),fi=r=>{const{spotify:e,beta:t,youtube:i,selectedOption:o}=r;return[o===v.webamp?ci(r):ui(r),t?hi(r):null,e?pi(r):null,i?gi(r):null,vi(r)].filter(Boolean)};/**
 * @license
 ...
 */const bi=Re(class extends Oe{constructor(r){super(r),this.et=new WeakMap}render(r){return[r]}update(r,[e]){if(se(this.it)&&(!se(e)||this.it.strings!==e.strings)){const t=st(r).pop();let i=this.et.get(this.it.strings);if(i===void 0){const o=document.createDocumentFragment();i=yt(m,o),i.setConnected(!1),this.et.set(this.it.strings,i)}ot(i,[t]),rt(i,void 0,t)}if(se(e)){if(!se(this.it)||this.it.strings!==e.strings){const t=this.et.get(e.strings);if(t!==void 0){const i=st(t).pop();wi(r),rt(r,void 0,i),ot(r,[i])}}this.it=e}else this.it=void 0;return this.render(e)}});let B=class extends k{constructor(){super(...arguments),this.open=!1,this.displayCaret=!1,this.selectedOption="",this.options=[],this.optionGroup="options",this.optionSelected=()=>{}}renderOption(e){const{label:t,url:i=void 0,id:o}=e;let s;const a=this.selectedOption===o?"selected":"";return i?s=u`<a
  ...
  `;n([g({type:Boolean,attribute:!0})],B.prototype,"open",void 0);n([g({type:Boolean,attribute:!0})],B.prototype,"displayCaret",void 0);n([g({type:String,attribute:!0})],B.prototype,"selectedOption",void 0);n([g({type:Array})],B.prototype,"options",void 0);n([g({type:String})],B.prototype,"optionGroup",void 0);n([g({type:Function})],B.prototype,"optionSelected",void 0);B=n([O("ia-dropdown")],B);const $i=M`
  section#radio {
    display: flex;
    flex-direction: row;
    align-items: center;
...
`;var ve;(function(r){r.postInit="postInit",r.channelChange="channelChange"})(ve||(ve={}));let A=class extends k{constructor(){super(...arguments),this.youtube=!1,this.spotify=!1,this.beta=!1,this.webamp=!0,this.samples=!1,this.backgroundTheme="dark",this.selected=v.ia,this.displayStyle="radio",this.url=""}firstUpdated(){this.dispatchEvent(new CustomEvent(ve.postInit,{detail:{channel:this.selected},composed:!0,bubbles:!0}))}emitChannelChanged(){this.dispatchEvent(new CustomEvent(ve.channelChange,{detail:{channel:this.selected},composed:!0,bubbles:!0}))}iaClicked(){this.selected!==v.ia&&(this.selected=v.ia,this.emitChannelChanged())}betaClicked(){this.selected!==v.beta&&(this.selected=v.beta,this.emitChannelChanged())}spotifyClicked(){this.selected!==v.spotify&&(this.selected=v.spotify,this.emitChannelChanged())}webampClicked(){this.selected!==v.webamp&&(this.selected=v.webamp,this.emitChannelChanged())}youtubeClicked(){this.selected!==v.youtube&&(this.selected=v.youtube,this.emitChannelChanged())}dropdownOptionSelected(e){this.selected=e.id,this.emitChannelChanged(),this.iaDropdown.open=!1}get iaLinkSelector(){const e=this.selected===v.ia?"selected":"";return u`
    ...
    `,$i];n([g({attribute:!0,type:Boolean,reflect:!0})],A.prototype,"youtube",void 0);n([g({attribute:!0,type:Boolean,reflect:!0})],A.prototype,"spotify",void 0);n([g({attribute:!0,type:Boolean,reflect:!0})],A.prototype,"beta",void 0);n([g({attribute:!0,type:Boolean,reflect:!0})],A.prototype,"webamp",void 0);n([g({attribute:!0,type:Boolean,reflect:!0})],A.prototype,"samples",void 0);n([g({attribute:!0,type:String,reflect:!0})],A.prototype,"backgroundTheme",void 0);n([g({type:String,reflect:!0})],A.prototype,"selected",void 0);n([g({type:String,reflect:!0})],A.prototype,"displayStyle",void 0);n([g({type:String})],A.prototype,"url",void 0);n([Z("ia-dropdown")],A.prototype,"iaDropdown",void 0);A=n([O("channel-selector")],A);let re=class extends k{constructor(){super(...arguments),this.iaSpotifyUrn="",this.display=!1}get spotifyUrl(){return!this.iaSpotifyUrn||!this.iaSpotifyUrn.match(/urn:spotify:/g)?"":`https://open.spotify.com/embed/${this.iaSpotifyUrn.replace(/urn:spotify:/g,"").replace(/:/g,"/")}`}render(){const e=this.spotifyUrl;return e?u`
      <iframe
        id="embed-iframe"
        src="${e}"
        width="100%"
    ...
    `:u`<h3>Invalid Spotify URI: ${this.iaSpotifyUrn}</h3>`}static get styles(){return[M`
      ...
      `]}};n([g({type:String,reflect:!0})],re.prototype,"iaSpotifyUrn",void 0);n([g({type:Boolean,reflect:!0})],re.prototype,"display",void 0);n([Z("iframe")],re.prototype,"iframe",void 0);re=n([O("spotify-player")],re);let Y=class extends k{constructor(){super(...arguments),this.iaYouTubeUrn="",this.display=!1,this.baseHost="https://archive.org"}get youTubeUrl(){if(!this.iaYouTubeUrn||!this.iaYouTubeUrn.match(/urn:youtube:/g))return"";const t=this.iaYouTubeUrn.replace(/urn:youtube:/g,"").replace(/:/g,"/"),i=`origin=${this.baseHost}&widgetid=1&autoplay=1&rel=0`;return`https://www.youtube.com/embed/${t}?${i}`}render(){const e=this.youTubeUrl;return e?u`
      <iframe
        id="embed-iframe"
        src="${e}"
        width="100%"
  ...
  `;n([g({type:String,reflect:!0})],$.prototype,"viewToShow",void 0);n([g({type:String})],$.prototype,"selectedByDropdown",void 0);n([g({type:String})],$.prototype,"errorMsg",void 0);n([g({type:String})],$.prototype,"selectedByDropdownOnload",void 0);n([g({type:String})],$.prototype,"selectedByRadio",void 0);n([g({type:String})],$.prototype,"selectedByRadioOnload",void 0);n([g({type:String})],$.prototype,"albumId",void 0);n([g({type:String})],$.prototype,"bgColor",void 0);n([g({type:Object,attribute:!1})],$.prototype,"albumMd",void 0);n([g({type:Object,attribute:!1})],$.prototype,"albumPlaylist",void 0);n([g({type:Object,attribute:!1})],$.prototype,"album",void 0);n([g({type:String})],$.prototype,"componentToShow",void 0);n([Z("input#md-search")],$.prototype,"input",void 0);n([Z("iaux-photo-viewer")],$.prototype,"photoViewerEl",void 0);n([g({type:Boolean})],$.prototype,"signedIn",void 0);n([g({type:String})],$.prototype,"photoDisplay",void 0);$=n([O("app-root")],$);
