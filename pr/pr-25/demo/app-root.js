 ...
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */var He;const we=window,X=we.trustedTypes,ct=X?X.createPolicy("lit-html",{createHTML:r=>r}):void 0,$e="$lit$",H=`lit$${(Math.random()+"").slice(9)}$`,Xe="?"+H,ci=`<${Xe}>`,ee=document,ne=()=>ee.createComment(""),le=r=>r===null||typeof r!="object"&&typeof r!="function",Ht=Array.isArray,Rt=r=>Ht(r)||typeof r?.[Symbol.iterator]=="function",Re=`[ 	
\f\r]`,se=/<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g,ht=/-->/g,ut=/>/g,j=RegExp(`>|${Re}(?:([^\\s"'>=/]+)(${Re}*=${Re}*(?:[^ 	
\f\r"'\`<>=]|("|')|))|$)`,"g"),pt=/'/g,vt=/"/g,Ot=/^(?:script|style|textarea|title)$/i,Dt=r=>(e,...t)=>({_$litType$:r,strings:e,values:t}),u=Dt(1),Lt=Dt(2),U=Symbol.for("lit-noChange"),b=Symbol.for("lit-nothing"),ft=new WeakMap,Q=ee.createTreeWalker(ee,129,null,!1),Vt=(r,e)=>{const t=r.length-1,i=[];let o,s=e===2?"<svg>":"",a=se;for(let n=0;n<t;n++){const c=r[n];let y,h,g=-1,w=0;for(;w<c.length&&(a.lastIndex=w,h=a.exec(c),h!==null);)w=a.lastIndex,a===se?h[1]==="!--"?a=ht:h[1]!==void 0?a=ut:h[2]!==void 0?(Ot.test(h[2])&&(o=RegExp("</"+h[2],"g")),a=j):h[3]!==void 0&&(a=j):a===j?h[0]===">"?(a=o??se,g=-1):h[1]===void 0?g=-2:(g=a.lastIndex-h[2].length,y=h[1],a=h[3]===void 0?j:h[3]==='"'?vt:pt):a===vt||a===pt?a=j:a===ht||a===ut?a=se:(a=j,o=void 0);const D=a===j&&r[n+1].startsWith("/>")?" ":"";s+=a===se?c+ci:g>=0?(i.push(y),c.slice(0,g)+$e+c.slice(g)+H+D):c+H+(g===-2?(i.push(void 0),n):D)}const d=s+(r[t]||"<?>")+(e===2?"</svg>":"");if(!Array.isArray(r)||!r.hasOwnProperty("raw"))throw Error("invalid template strings array");return[ct!==void 0?ct.createHTML(d):d,i]};class de{constructor({strings:e,_$litType$:t},i){let o;this.parts=[];let s=0,a=0;const d=e.length-1,n=this.parts,[c,y]=Vt(e,t);if(this.el=de.createElement(c,i),Q.currentNode=this.el.content,t===2){const h=this.el.content,g=h.firstChild;g.remove(),h.append(...g.childNodes)}for(;(o=Q.nextNode())!==null&&n.length<d;){if(o.nodeType===1){if(o.hasAttributes()){const h=[];for(const g of o.getAttributeNames())if(g.endsWith($e)||g.startsWith(H)){const w=y[a++];if(h.push(g),w!==void 0){const D=o.getAttribute(w.toLowerCase()+$e).split(H),B=/([.?@])?(.*)/.exec(w);n.push({type:1,index:s,name:B[2],strings:D,ctor:B[1]==="."?Ft:B[1]==="?"?zt:B[1]==="@"?jt:fe})}else n.push({type:6,index:s})}for(const g of h)o.removeAttribute(g)}if(Ot.test(o.tagName)){const h=o.textContent.split(H),g=h.length-1;if(g>0){o.textContent=X?X.emptyScript:"";for(let w=0;w<g;w++)o.append(h[w],ne()),Q.nextNode(),n.push({type:2,index:++s});o.append(h[g],ne())}}}else if(o.nodeType===8)if(o.data===Xe)n.push({type:2,index:s});else{let h=-1;for(;(h=o.data.indexOf(H,h+1))!==-1;)n.push({type:7,index:s}),h+=H.length-1}s++}}static createElement(e,t){const i=ee.createElement("template");return i.innerHTML=e,i}}function Y(r,e,t=r,i){var o,s,a,d;if(e===U)return e;let n=i!==void 0?(o=t._$Co)===null||o===void 0?void 0:o[i]:t._$Cl;const c=le(e)?void 0:e._$litDirective$;return n?.constructor!==c&&((s=n?._$AO)===null||s===void 0||s.call(n,!1),c===void 0?n=void 0:(n=new c(r),n._$AT(r,t,i)),i!==void 0?((a=(d=t)._$Co)!==null&&a!==void 0?a:d._$Co=[])[i]=n:t._$Cl=n),n!==void 0&&(e=Y(r,n._$AS(r,e.values),n,i)),e}class Ut{constructor(e,t){this.u=[],this._$AN=void 0,this._$AD=e,this._$AM=t}get parentNode(){return this._$AM.parentNode}get _$AU(){return this._$AM._$AU}v(e){var t;const{el:{content:i},parts:o}=this._$AD,s=((t=e?.creationScope)!==null&&t!==void 0?t:ee).importNode(i,!0);Q.currentNode=s;let a=Q.nextNode(),d=0,n=0,c=o[0];for(;c!==void 0;){if(d===c.index){let y;c.type===2?y=new re(a,a.nextSibling,this,e):c.type===1?y=new c.ctor(a,c.name,c.strings,this,e):c.type===6&&(y=new Wt(a,this,e)),this.u.push(y),c=o[++n]}d!==c?.index&&(a=Q.nextNode(),d++)}return s}p(e){let t=0;for(const i of this.u)i!==void 0&&(i.strings!==void 0?(i._$AI(e,i,t),t+=i.strings.length-2):i._$AI(e[t])),t++}}class re{constructor(e,t,i,o){var s;this.type=2,this._$AH=b,this._$AN=void 0,this._$AA=e,this._$AB=t,this._$AM=i,this.options=o,this._$Cm=(s=o?.isConnected)===null||s===void 0||s}get _$AU(){var e,t;return(t=(e=this._$AM)===null||e===void 0?void 0:e._$AU)!==null&&t!==void 0?t:this._$Cm}get parentNode(){let e=this._$AA.parentNode;const t=this._$AM;return t!==void 0&&e?.nodeType===11&&(e=t.parentNode),e}get startNode(){return this._$AA}get endNode(){return this._$AB}_$AI(e,t=this){e=Y(this,e,t),le(e)?e===b||e==null||e===""?(this._$AH!==b&&this._$AR(),this._$AH=b):e!==this._$AH&&e!==U&&this.g(e):e._$litType$!==void 0?this.$(e):e.nodeType!==void 0?this.T(e):Rt(e)?this.k(e):this.g(e)}S(e){return this._$AA.parentNode.insertBefore(e,this._$AB)}T(e){this._$AH!==e&&(this._$AR(),this._$AH=this.S(e))}g(e){this._$AH!==b&&le(this._$AH)?this._$AA.nextSibling.data=e:this.T(ee.createTextNode(e)),this._$AH=e}$(e){var t;const{values:i,_$litType$:o}=e,s=typeof o=="number"?this._$AC(e):(o.el===void 0&&(o.el=de.createElement(o.h,this.options)),o);if(((t=this._$AH)===null||t===void 0?void 0:t._$AD)===s)this._$AH.p(i);else{const a=new Ut(s,this),d=a.v(this.options);a.p(i),this.T(d),this._$AH=a}}_$AC(e){let t=ft.get(e.strings);return t===void 0&&ft.set(e.strings,t=new de(e)),t}k(e){Ht(this._$AH)||(this._$AH=[],this._$AR());const t=this._$AH;let i,o=0;for(const s of e)o===t.length?t.push(i=new re(this.S(ne()),this.S(ne()),this,this.options)):i=t[o],i._$AI(s),o++;o<t.length&&(this._$AR(i&&i._$AB.nextSibling,o),t.length=o)}_$AR(e=this._$AA.nextSibling,t){var i;for((i=this._$AP)===null||i===void 0||i.call(this,!1,!0,t);e&&e!==this._$AB;){const o=e.nextSibling;e.remove(),e=o}}setConnected(e){var t;this._$AM===void 0&&(this._$Cm=e,(t=this._$AP)===null||t===void 0||t.call(this,e))}}class fe{constructor(e,t,i,o,s){this.type=1,this._$AH=b,this._$AN=void 0,this.element=e,this.name=t,this._$AM=o,this.options=s,i.length>2||i[0]!==""||i[1]!==""?(this._$AH=Array(i.length-1).fill(new String),this.strings=i):this._$AH=b}get tagName(){return this.element.tagName}get _$AU(){return this._$AM._$AU}_$AI(e,t=this,i,o){const s=this.strings;let a=!1;if(s===void 0)e=Y(this,e,t,0),a=!le(e)||e!==this._$AH&&e!==U,a&&(this._$AH=e);else{const d=e;let n,c;for(e=s[0],n=0;n<s.length-1;n++)c=Y(this,d[i+n],t,n),c===U&&(c=this._$AH[n]),a||(a=!le(c)||c!==this._$AH[n]),c===b?e=b:e!==b&&(e+=(c??"")+s[n+1]),this._$AH[n]=c}a&&!o&&this.j(e)}j(e){e===b?this.element.removeAttribute(this.name):this.element.setAttribute(this.name,e??"")}}class Ft extends fe{constructor(){super(...arguments),this.type=3}j(e){this.element[this.name]=e===b?void 0:e}}const hi=X?X.emptyScript:"";class zt extends fe{constructor(){super(...arguments),this.type=4}j(e){e&&e!==b?this.element.setAttribute(this.name,hi):this.element.removeAttribute(this.name)}}class jt extends fe{constructor(e,t,i,o,s){super(e,t,i,o,s),this.type=5}_$AI(e,t=this){var i;if((e=(i=Y(this,e,t,0))!==null&&i!==void 0?i:b)===U)return;const o=this._$AH,s=e===b&&o!==b||e.capture!==o.capture||e.once!==o.once||e.passive!==o.passive,a=e!==b&&(o===b||s);s&&this.element.removeEventListener(this.name,this,o),a&&this.element.addEventListener(this.name,this,e),this._$AH=e}handleEvent(e){var t,i;typeof this._$AH=="function"?this._$AH.call((i=(t=this.options)===null||t===void 0?void 0:t.host)!==null&&i!==void 0?i:this.element,e):this._$AH.handleEvent(e)}}class Wt{constructor(e,t,i){this.element=e,this.type=6,this._$AN=void 0,this._$AM=t,this.options=i}get _$AU(){return this._$AM._$AU}_$AI(e){Y(this,e)}}const ui={P:$e,A:H,M:Xe,C:1,L:Vt,D:Ut,R:Rt,V:Y,I:re,H:fe,N:zt,U:jt,F:Ft,B:Wt},mt=we.litHtmlPolyfillSupport;mt?.(de,re),((He=we.litHtmlVersions)!==null&&He!==void 0?He:we.litHtmlVersions=[]).push("2.7.0");const qt=(r,e,t)=>{var i,o;const s=(i=t?.renderBefore)!==null&&i!==void 0?i:e;let a=s._$litPart$;if(a===void 0){const d=(o=t?.renderBefore)!==null&&o!==void 0?o:null;s._$litPart$=a=new re(e.insertBefore(ne(),d),d,void 0,t??{})}return a._$AI(r),a};/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */var Oe,De;class C extends J{constructor(){super(...arguments),this.renderOptions={host:this},this._$Do=void 0}createRenderRoot(){var e,t;const i=super.createRenderRoot();return(e=(t=this.renderOptions).renderBefore)!==null&&e!==void 0||(t.renderBefore=i.firstChild),i}update(e){const t=this.render();this.hasUpdated||(this.renderOptions.isConnected=this.isConnected),super.update(e),this._$Do=qt(t,this.renderRoot,this.renderOptions)}connectedCallback(){var e;super.connectedCallback(),(e=this._$Do)===null||e===void 0||e.setConnected(!0)}disconnectedCallback(){var e;super.disconnectedCallback(),(e=this._$Do)===null||e===void 0||e.setConnected(!1)}render(){return U}}C.finalized=!0,C._$litElement$=!0,(Oe=globalThis.litElementHydrateSupport)===null||Oe===void 0||Oe.call(globalThis,{LitElement:C});const gt=globalThis.litElementPolyfillSupport;gt?.({LitElement:C});((De=globalThis.litElementVersions)!==null&&De!==void 0?De:globalThis.litElementVersions=[]).push("3.3.0");/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 ...
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */function vi(r){return v({...r,state:!0})}/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const fi=({finisher:r,descriptor:e})=>(t,i)=>{var o;if(i===void 0){const s=(o=t.originalKey)!==null&&o!==void 0?o:t.key,a=e!=null?{kind:"method",placement:"prototype",key:s,descriptor:e(t.key)}:{...t,key:s};return r!=null&&(a.finisher=function(d){r(d,s)}),a}{const s=t.constructor;e!==void 0&&Object.defineProperty(t,i,e(i)),r?.(s,i)}};/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */function F(r,e){return fi({descriptor:t=>{const i={get(){var o,s;return(s=(o=this.renderRoot)===null||o===void 0?void 0:o.querySelector(r))!==null&&s!==void 0?s:null},enumerable:!0,configurable:!0};if(e){const o=typeof t=="symbol"?Symbol():"__"+t;i.get=function(){var s,a;return this[o]===void 0&&(this[o]=(a=(s=this.renderRoot)===null||s===void 0?void 0:s.querySelector(r))!==null&&a!==void 0?a:null),this[o]}}return i}})}/**
 * @license
 * Copyright 2021 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */var Le;((Le=window.HTMLSlotElement)===null||Le===void 0?void 0:Le.prototype.assignedElements)!=null;function p(r){let e,t,i;return typeof r=="object"?(e=r.hashFunction,t=r.expiring,i=r.tags):e=r,(o,s,a)=>{if(a.value!=null)a.value=yt(a.value,e,t,i);else if(a.get!=null)a.get=yt(a.get,e,t,i);else throw"Only put a Memoize() decorator on a method or get accessor."}}const Ve=new Map;function yt(r,e,t=0,i){const o=Symbol("__memoized_map__");return function(...s){let a;this.hasOwnProperty(o)||Object.defineProperty(this,o,{configurable:!1,enumerable:!1,writable:!1,value:new Map});let d=this[o];if(Array.isArray(i))for(const n of i)Ve.has(n)?Ve.get(n).push(d):Ve.set(n,[d]);if(e||s.length>0||t>0){let n;e===!0?n=s.map(h=>h.toString()).join("!"):e?n=e.apply(this,s):n=s[0];const c=`${n}__timestamp`;let y=!1;if(t>0)if(!d.has(c))y=!0;else{let h=d.get(c);y=Date.now()-h>t}d.has(n)&&!y?a=d.get(n):(a=r.apply(this,s),d.set(n,a),t>0&&d.set(c,Date.now()))}else{const n=this;d.has(n)?a=d.get(n):(a=r.apply(this,s),d.set(n,a))}return a}}class We{parseValue(e){return typeof e=="string"&&(e==="false"||e==="0")?!1:Boolean(e)}}We.shared=new We;class V{parseValue(e){if(typeof e=="number")return e;if(typeof e=="boolean")return;const t=parseFloat(e);if(!Number.isNaN(t))return t}}V.shared=new V;class _e{parseValue(e){return V.shared.parseValue(e)}}_e.shared=new _e;class ce{parseValue(e){return this.parseJSDate(e)||this.parseBracketDate(e)}parseBracketDate(e){if(typeof e!="string")return;const t=e.match(/\[([0-9]{4})\]/);if(!(!t||t.length<2))return this.parseJSDate(t[1])}parseJSDate(e){if(typeof e!="string")return;let t=e;t.match(/^[0-9]{4}-[0-9]{2}-[0-9]{2}\s{1}[0-9]{2}:[0-9]{2}:[0-9]{2}$/)&&(t=t.replace(" ","T"));const i=Date.parse(t);if(Number.isNaN(i))return;let o=new Date(t);return(t.indexOf("Z")>-1||t.indexOf("+")>-1||t.match(/^[0-9]{4}$/)||t.match(/^[0-9]{4}-[0-9]{2}-[0-9]{2}$/)||t.match(/^.*?-[0-9]{2}:[0-9]{2}$/)||t.match(/^.*?-[0-9]{4}$/))&&(o=new Date(o.getTime()+o.getTimezoneOffset()*1e3*60)),o}}ce.shared=new ce;class ke{parseValue(e){if(typeof e=="number")return e;if(typeof e=="boolean")return;const t=e.split(":");let i;return t.length===1?i=this.parseNumberFormat(t[0]):i=this.parseColonSeparatedFormat(t),i}parseNumberFormat(e){let t=parseFloat(e);return Number.isNaN(t)&&(t=void 0),t}parseColonSeparatedFormat(e){let t=!1;const i=e.map((o,s)=>{const a=parseFloat(o);if(Number.isNaN(a))return t=!0,0;const d=e.length-1-s,n=60**d;return a*Math.floor(n)}).reduce((o,s)=>o+s,0);return t?void 0:i}}ke.shared=new ke;class qe{parseValue(e){if(typeof e=="string")return e}}qe.shared=new qe;class mi{constructor(e,t){this.separators=[";",","],this.parser=e,t&&t.separators&&(this.separators=t.separators)}parseValue(e){const t=String(e);let i=[];for(const o of this.separators)if(i=t.split(o),i.length>1)break;return this.parseListValues(i)}parseListValues(e){const i=e.map(s=>s.trim()).map(s=>this.parser.parseValue(s)),o=[];return i.forEach(s=>{s!==void 0&&o.push(s)}),o}}class Ke{parseValue(e){if(typeof e=="string")return e}}Ke.shared=new Ke;class xe{parseValue(e){return String(e)}}xe.shared=new xe;class E{constructor(e,t){this.parser=e,this.rawValue=t}get values(){return this.parseRawValue()}get value(){return this.values[0]}parseRawValue(){if(this.rawValue===void 0)return[];const e=Array.isArray(this.rawValue)?this.rawValue:[this.rawValue],t=[];return e.forEach(i=>{const o=this.parser.parseValue(i);Array.isArray(o)?t.push(...o):o!==void 0&&t.push(o)}),t}}l([p()],E.prototype,"values",null);l([p()],E.prototype,"value",null);class gi extends E{constructor(e){super(We.shared,e)}}class N extends E{constructor(e){super(ce.shared,e)}}class Ue extends E{constructor(e){super(ke.shared,e)}}class I extends E{constructor(e){super(V.shared,e)}}class $ extends E{constructor(e){super(xe.shared,e)}}class yi extends E{constructor(e){super(Ke.shared,e)}}class bt extends E{constructor(e){super(_e.shared,e)}}class bi extends E{constructor(e){super(qe.shared,e)}}class wi extends E{constructor(e,t){super(t,e)}}class $i extends wi{constructor(e){const t=new mi(xe.shared);super(e,t)}}class m{constructor(e){this.rawMetadata=e}get identifier(){var e;return(e=this.rawMetadata)===null||e===void 0?void 0:e.identifier}get addeddate(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.addeddate?new N(this.rawMetadata.addeddate):void 0}get audio_codec(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.audio_codec?new $(this.rawMetadata.audio_codec):void 0}get audio_sample_rate(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.audio_sample_rate?new I(this.rawMetadata.audio_sample_rate):void 0}get avg_rating(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.avg_rating?new I(this.rawMetadata.avg_rating):void 0}get collection(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.collection?new $(this.rawMetadata.collection):void 0}get collections_raw(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.collections_raw?new $(this.rawMetadata.collections_raw):void 0}get collection_size(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.collection_size?new bt(this.rawMetadata.collection_size):void 0}get contributor(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.contributor?new $(this.rawMetadata.contributor):void 0}get coverage(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.coverage?new $(this.rawMetadata.coverage):void 0}get creator(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.creator?new $(this.rawMetadata.creator):void 0}get date(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.date?new N(this.rawMetadata.date):void 0}get description(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.description?new $(this.rawMetadata.description):void 0}get downloads(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.downloads?new I(this.rawMetadata.downloads):void 0}get duration(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.duration?new Ue(this.rawMetadata.duration):void 0}get"external-identifier"(){var e,t;return!((e=this.rawMetadata)===null||e===void 0)&&e["external-identifier"]?new $((t=this.rawMetadata)===null||t===void 0?void 0:t["external-identifier"]):void 0}get files_count(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.files_count?new I(this.rawMetadata.files_count):void 0}get indexdate(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.indexdate?new N(this.rawMetadata.indexdate):void 0}get isbn(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.isbn?new $(this.rawMetadata.isbn):void 0}get issue(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.issue?new $(this.rawMetadata.issue):void 0}get item_count(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.item_count?new I(this.rawMetadata.item_count):void 0}get item_size(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.item_size?new bt(this.rawMetadata.item_size):void 0}get language(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.language?new $(this.rawMetadata.language):void 0}get length(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.length?new Ue(this.rawMetadata.length):void 0}get lineage(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.lineage?new $(this.rawMetadata.lineage):void 0}get month(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.month?new I(this.rawMetadata.month):void 0}get mediatype(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.mediatype?new bi(this.rawMetadata.mediatype):void 0}get noindex(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.noindex?new gi(this.rawMetadata.noindex):void 0}get notes(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.notes?new $(this.rawMetadata.notes):void 0}get num_favorites(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.num_favorites?new I(this.rawMetadata.num_favorites):void 0}get num_reviews(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.num_reviews?new I(this.rawMetadata.num_reviews):void 0}get openlibrary_edition(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.openlibrary_edition?new $(this.rawMetadata.openlibrary_edition):void 0}get openlibrary_work(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.openlibrary_work?new $(this.rawMetadata.openlibrary_work):void 0}get page_progression(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.page_progression?new yi(this.rawMetadata.page_progression):void 0}get partner(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.partner?new $(this.rawMetadata.partner):void 0}get ppi(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.ppi?new I(this.rawMetadata.ppi):void 0}get publicdate(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.publicdate?new N(this.rawMetadata.publicdate):void 0}get publisher(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.publisher?new $(this.rawMetadata.publisher):void 0}get reviewdate(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.reviewdate?new N(this.rawMetadata.reviewdate):void 0}get runtime(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.runtime?new Ue(this.rawMetadata.runtime):void 0}get scanner(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.scanner?new $(this.rawMetadata.scanner):void 0}get source(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.source?new $(this.rawMetadata.source):void 0}get start_localtime(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.start_localtime?new N(this.rawMetadata.start_localtime):void 0}get start_time(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.start_time?new N(this.rawMetadata.start_time):void 0}get stop_time(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.stop_time?new N(this.rawMetadata.stop_time):void 0}get subject(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.subject?new $i(this.rawMetadata.subject):void 0}get taper(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.taper?new $(this.rawMetadata.taper):void 0}get title(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.title?new $(this.rawMetadata.title):void 0}get transferer(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.transferer?new $(this.rawMetadata.transferer):void 0}get track(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.track?new I(this.rawMetadata.track):void 0}get type(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.type?new $(this.rawMetadata.type):void 0}get uploader(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.uploader?new $(this.rawMetadata.uploader):void 0}get utc_offset(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.utc_offset?new I(this.rawMetadata.utc_offset):void 0}get venue(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.venue?new $(this.rawMetadata.venue):void 0}get volume(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.volume?new $(this.rawMetadata.volume):void 0}get week(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.week?new I(this.rawMetadata.week):void 0}get year(){var e;return!((e=this.rawMetadata)===null||e===void 0)&&e.year?new N(this.rawMetadata.year):void 0}}l([p()],m.prototype,"addeddate",null);l([p()],m.prototype,"audio_codec",null);l([p()],m.prototype,"audio_sample_rate",null);l([p()],m.prototype,"avg_rating",null);l([p()],m.prototype,"collection",null);l([p()],m.prototype,"collections_raw",null);l([p()],m.prototype,"collection_size",null);l([p()],m.prototype,"contributor",null);l([p()],m.prototype,"coverage",null);l([p()],m.prototype,"creator",null);l([p()],m.prototype,"date",null);l([p()],m.prototype,"description",null);l([p()],m.prototype,"downloads",null);l([p()],m.prototype,"duration",null);l([p()],m.prototype,"external-identifier",null);l([p()],m.prototype,"files_count",null);l([p()],m.prototype,"indexdate",null);l([p()],m.prototype,"isbn",null);l([p()],m.prototype,"issue",null);l([p()],m.prototype,"item_count",null);l([p()],m.prototype,"item_size",null);l([p()],m.prototype,"language",null);l([p()],m.prototype,"length",null);l([p()],m.prototype,"lineage",null);l([p()],m.prototype,"month",null);l([p()],m.prototype,"mediatype",null);l([p()],m.prototype,"noindex",null);l([p()],m.prototype,"notes",null);l([p()],m.prototype,"num_favorites",null);l([p()],m.prototype,"num_reviews",null);l([p()],m.prototype,"openlibrary_edition",null);l([p()],m.prototype,"openlibrary_work",null);l([p()],m.prototype,"page_progression",null);l([p()],m.prototype,"partner",null);l([p()],m.prototype,"ppi",null);l([p()],m.prototype,"publicdate",null);l([p()],m.prototype,"publisher",null);l([p()],m.prototype,"reviewdate",null);l([p()],m.prototype,"runtime",null);l([p()],m.prototype,"scanner",null);l([p()],m.prototype,"source",null);l([p()],m.prototype,"start_localtime",null);l([p()],m.prototype,"start_time",null);l([p()],m.prototype,"stop_time",null);l([p()],m.prototype,"subject",null);l([p()],m.prototype,"taper",null);l([p()],m.prototype,"title",null);l([p()],m.prototype,"transferer",null);l([p()],m.prototype,"track",null);l([p()],m.prototype,"type",null);l([p()],m.prototype,"uploader",null);l([p()],m.prototype,"utc_offset",null);l([p()],m.prototype,"venue",null);l([p()],m.prototype,"volume",null);l([p()],m.prototype,"week",null);l([p()],m.prototype,"year",null);class z{constructor(e){this.rawValue=e}get name(){return this.rawValue.name}get source(){return this.rawValue.source}get btih(){return this.rawValue.btih}get md5(){return this.rawValue.md5}get format(){return this.rawValue.format}get mtime(){return this.rawValue.mtime}get crc32(){return this.rawValue.crc32}get sha1(){return this.rawValue.sha1}get original(){return this.rawValue.original}get size(){return this.rawValue.size?_e.shared.parseValue(this.rawValue.size):void 0}get title(){return this.rawValue.title}get length(){return this.rawValue.length?ke.shared.parseValue(this.rawValue.length):void 0}get height(){return this.rawValue.height?V.shared.parseValue(this.rawValue.height):void 0}get width(){return this.rawValue.width?V.shared.parseValue(this.rawValue.width):void 0}get track(){return this.rawValue.track?V.shared.parseValue(this.rawValue.track):void 0}get external_identifier(){return this.rawValue.external_identifier}get creator(){return this.rawValue.creator}get album(){return this.rawValue.album}}l([p()],z.prototype,"size",null);l([p()],z.prototype,"length",null);l([p()],z.prototype,"height",null);l([p()],z.prototype,"width",null);l([p()],z.prototype,"track",null);class Me{constructor(e){this.rawValue=e}get reviewbody(){return this.rawValue.reviewbody}get reviewtitle(){return this.rawValue.reviewtitle}get reviewer(){return this.rawValue.reviewer}get reviewdate(){return this.rawValue.reviewdate?ce.shared.parseValue(this.rawValue.reviewdate):void 0}get createdate(){return this.rawValue.createdate?ce.shared.parseValue(this.rawValue.createdate):void 0}get stars(){return this.rawValue.stars?V.shared.parseValue(this.rawValue.stars):void 0}}l([p()],Me.prototype,"reviewdate",null);l([p()],Me.prototype,"createdate",null);l([p()],Me.prototype,"stars",null);class et{constructor(e){var t,i;this.rawResponse=e,this.created=e.created,this.d1=e.d1,this.d2=e.d2,this.dir=e.dir,this.files=(t=e.files)===null||t===void 0?void 0:t.map(o=>new z(o)),this.files_count=e.files_count,this.item_last_updated=e.item_last_updated,this.item_size=e.item_size,this.metadata=new m(e.metadata),this.server=e.server,this.uniq=e.uniq,this.workable_servers=e.workable_servers,this.speech_vs_music_asr=e.speech_vs_music_asr,this.reviews=(i=e.reviews)===null||i===void 0?void 0:i.map(o=>new Me(o))}}class _i{constructor(e){this.numFound=e.numFound,this.start=e.start,this.docs=e.docs.map(t=>new m(t)),this.aggregations=e.aggregations}}class ki{constructor(e){this.rawResponse=e,this.responseHeader=e.responseHeader,this.response=new _i(e.response)}}var K;(function(r){r.networkError="SearchService.NetworkError",r.itemNotFound="SearchService.ItemNotFound",r.decodingError="SearchService.DecodingError",r.searchEngineError="SearchService.SearchEngineError"})(K||(K={}));class Ye extends Error{constructor(e,t,i){super(t),this.name=e,this.type=e,this.details=i}}class xi{static aggregateSearchParamsAsString(e){if(e.advancedParams){const t=e.advancedParams.map(o=>({terms:o}));return JSON.stringify(t)}if(e.simpleParams)return e.simpleParams.join(",")}static sortParamsAsString(e){return`${e.field} ${e.direction}`}static generateURLSearchParams(e){const t=new URLSearchParams;if(t.append("q",e.query),t.append("output","json"),e.rows&&t.append("rows",String(e.rows)),e.page&&t.append("page",String(e.page)),e.fields&&t.append("fl",e.fields.join(",")),e.sort){const o=e.sort.map(s=>this.sortParamsAsString(s));t.append("sort",o.join(","))}const i=e.aggregations;if(i){const o=this.aggregateSearchParamsAsString(i);o&&t.append("user_aggs",o)}return t}}class Ai{constructor(e){var t;if(this.baseUrl=(t=e?.baseUrl)!==null&&t!==void 0?t:"archive.org",e?.includeCredentials!==void 0?this.includeCredentials=e.includeCredentials:this.includeCredentials=window.location.href.match(/^https?:\/\/.*archive\.org(:[0-9]+)?/)!==null,e?.scope!==void 0)this.requestScope=e.scope;else{const o=new URL(window.location.href).searchParams.get("scope");o&&(this.requestScope=o)}}async performSearch(e){const i=xi.generateURLSearchParams(e).toString(),o=`https://${this.baseUrl}/advancedsearch.php?${i}`;return this.fetchUrl(o)}async fetchMetadata(e,t){const i=t?`/${t}`:"",o=`https://${this.baseUrl}/metadata/${e}${i}`;return this.fetchUrl(o,{requestOptions:{credentials:"omit"}})}async fetchUrl(e,t){var i;const o=new URL(e);this.requestScope&&o.searchParams.set("scope",this.requestScope);let s;try{const a=(i=t?.requestOptions)!==null&&i!==void 0?i:{credentials:this.includeCredentials?"include":"same-origin"};s=await fetch(o.href,a)}catch(a){const d=a instanceof Error?a.message:typeof a=="string"?a:"Unknown error";return this.getErrorResult(K.networkError,d)}try{const a=await s.json(),d=a.error;if(d){const n=a.forensics;return this.getErrorResult(K.searchEngineError,d,n)}else return{success:a}}catch(a){const d=a instanceof Error?a.message:typeof a=="string"?a:"Unknown error";return this.getErrorResult(K.decodingError,d)}}getErrorResult(e,t,i){return{error:new Ye(e,t,i)}}}class wt{constructor(e){this.searchBackend=e}async search(e){const t=await this.searchBackend.performSearch(e);return t.error?t:{success:new ki(t.success)}}async fetchMetadata(e){var t;const i=await this.searchBackend.fetchMetadata(e);return i.error?i:((t=i.success)===null||t===void 0?void 0:t.metadata)===void 0?{error:new Ye(K.itemNotFound)}:{success:new et(i.success)}}async fetchMetadataValue(e,t){var i;const o=await this.searchBackend.fetchMetadata(e,t);return o.error?o:((i=o.success)===null||i===void 0?void 0:i.result)===void 0?{error:new Ye(K.itemNotFound)}:{success:o.success.result}}}wt.default=new wt(new Ai);var Si=u`
  <svg
    viewBox="0 0 12 12"
...
`;class Ci extends C{static get styles(){return x`
      :host {
    ...
    `}render(){return Si}}customElements.define("ia-icon-close-circle",Ci);function Kt(){return{el:"#BookReader",showToolbar:!1,onePage:{autofit:"height"},enableFSLogoShortcut:!0,enableBookmarks:!1,enablePageResume:!1,enableTtsPlugin:!1,enableUrlPlugin:!1,defaults:"mode/1up",enableSearch:!0,searchInsideUrl:"/fulltext/inside.php",initialSearchTerm:null,imagesBaseURL:"/bookreader/BookReader/images/",defaultStartLeaf:0,titleLeaf:0,controls:{twoPage:{visible:!1},viewmode:{visible:!1},bookLeft:{visible:!1},bookRight:{visible:!1}},bookType:"linerNotes"}}function Ti(r){var e;const t=r.brOptions,i={...Kt(),...t},o=new window.BookReader(i),s=window.BookReader.prototype.getPageURI;o.getPageURI=(d,n=1,c=0)=>{const y=Math.pow(2,Math.floor(Math.log2(Math.max(1,n)))),h=s.call(o,d,y,c);if(!h)return h;const g=h.indexOf("?")>-1?"&":"?";return`${h}${g}scale=${y}&rotate=${c}`},window.br=o;const a=(e=r?.data)===null||e===void 0?void 0:e.isRestricted;return window.dispatchEvent(new CustomEvent("contextmenu",{detail:{isRestricted:a}})),o}async function Mi(r){return await new Promise((t,i)=>{const o=new Image;o.onload=()=>t(o),o.onerror=i,o.src=r})}async function Ii(r){const e=[];return await Promise.all(r.map(async t=>{let i;try{i=await Mi(t.uri)}catch{i=new Image(300,300)}console.log("^^^^^^^^^^^^^^ FETCH IMAGE ~~~~~~~",i,i.height,i.width);const o=r.indexOf(t);e[o]={...t,width:i.width,height:i.height}})),e}async function Ei({images:r=[],itemIdentifier:e="",itemTitle:t="",baseHost:i="archive.org"}){const o=(await fetch(`https://${i}/metadata/${e}/metadata`).then(g=>g.json())).result||{},s=r.map((g,w)=>{const D=w%2===1?"L":"R";return console.log("imgPath",g),{uri:`https://${i}/download/${e}${g}`,leafNum:w,pageType:"Normal",pageSide:D}}),a=await Ii(s),d=[];a.forEach((g,w)=>{if(w===0){d.push([g]);return}if(w%2===1){d.push([g]);return}w%2===0&&d[d.length-1].push(g)});const c={...{bookId:e,bookPath:`/download/${e}`,bookTitle:t,defaults:"mode/1up",dfaultStartLeaf:0,ppi:200,data:d},...Kt(),enableSearch:!1,plugins:{textSelection:{enabled:!1}}},h={data:{streamOnly:!1,isRestricted:!1,id:e,subPrefix:e,bookUrl:`/details/${e}`},brOptions:c,metadata:o};return console.log("**** MANIFEST _---",h,c),h}var Bi=u`
<svg
  viewBox="0 0 40 40"
  version="1.1"
  xmlns="http://www.w3.org/2000/svg"
...
`;class Pi extends C{static get styles(){return x`
      :host {
        width: var(--iconWidth, 'auto');
        height: var(--iconHeight, 'auto');
      }
  ...
  `;l([v({type:String,reflect:!0,attribute:!0})],he.prototype,"iaIdentifier",void 0);l([v({type:String,reflect:!0})],he.prototype,"gradType",void 0);he=l([O("iamusic-noimage")],he);var Ni=u`
  <svg
    id="more-inside-icon"
    xmlns="http://www.w3.org/2000/svg"
    viewBox="0 0 100 100"
...
`;let S=class extends C{constructor(){super(...arguments),this.showAllPhotos=!1,this.baseHost="archive.org",this.signedIn=!1,this.itemIdentifier="",this.fullscreenActive=!1,this.reInitBrAtFullscreen=!1,this.noImageAvailable=!1,this.backgroundTheme="dark",this.bindBrEvents=()=>{window.addEventListener("BookReader:PostInit",this.handleBrPostInit),window.addEventListener("BookReader:fullscreenToggled",()=>{var e;this.fullscreenActive=((e=this.bookreader)===null||e===void 0?void 0:e.isFullscreen())||!1;const t=this.fullscreenActive?"fullscreenOpened":"fullscreenClosed";this.dispatchEvent(new Event(t))})}}disconnectedCallback(){super.disconnectedCallback(),window.removeEventListener("BookReader:PostInit",this.handleBrPostInit)}firstUpdated(){this.bindBrEvents()}updated(e){e.has("linerNotesManifest")&&this.linerNotesManifest&&this.loadFreshBookReaderFromManifest(),e.has("showAllPhotos")&&this.showAllPhotos&&(this.bookreader?setTimeout(()=>{var t;return(t=this.bookreader)===null||t===void 0?void 0:t.resize()},500):this.initBr(500))}render(){if(this.noImageAvailable)return u`
  ...
  `;l([v({type:Boolean,reflect:!0})],S.prototype,"showAllPhotos",void 0);l([v({type:String,attribute:!0,reflect:!0})],S.prototype,"baseHost",void 0);l([v({type:Boolean,reflect:!0})],S.prototype,"signedIn",void 0);l([v({type:String,reflect:!0,attribute:!0})],S.prototype,"itemIdentifier",void 0);l([v({type:Object})],S.prototype,"itemMD",void 0);l([v({type:Object})],S.prototype,"linerNotesManifest",void 0);l([v({type:Object})],S.prototype,"bookreader",void 0);l([v({type:Boolean,reflect:!0})],S.prototype,"fullscreenActive",void 0);l([v({type:Boolean})],S.prototype,"reInitBrAtFullscreen",void 0);l([v({type:Boolean,reflect:!0})],S.prototype,"noImageAvailable",void 0);l([v({attribute:!0,type:String,reflect:!0})],S.prototype,"backgroundTheme",void 0);l([v({type:Object})],S.prototype,"lightDomHook",void 0);l([F("button.click-for-photos img")],S.prototype,"coverImage",void 0);S=l([O("iaux-photo-viewer")],S);/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */var Fe;const Ae=window,te=Ae.trustedTypes,$t=te?te.createPolicy("lit-html",{createHTML:r=>r}):void 0,Ze="$lit$",L=`lit$${(Math.random()+"").slice(9)}$`,Yt="?"+L,Hi=`<${Yt}>`,Z=document,Se=()=>Z.createComment(""),ue=r=>r===null||typeof r!="object"&&typeof r!="function",Zt=Array.isArray,Ri=r=>Zt(r)||typeof r?.[Symbol.iterator]=="function",ze=`[ 	
\f\r]`,ae=/<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g,_t=/-->/g,kt=/>/g,W=RegExp(`>|${ze}(?:([^\\s"'>=/]+)(${ze}*=${ze}*(?:[^ 	
\f\r"'\`<>=]|("|')|))|$)`,"g"),xt=/'/g,At=/"/g,Gt=/^(?:script|style|textarea|title)$/i,pe=Symbol.for("lit-noChange"),k=Symbol.for("lit-nothing"),St=new WeakMap,q=Z.createTreeWalker(Z,129,null,!1);function Jt(r,e){if(!Array.isArray(r)||!r.hasOwnProperty("raw"))throw Error("invalid template strings array");return $t!==void 0?$t.createHTML(e):e}const Oi=(r,e)=>{const t=r.length-1,i=[];let o,s=e===2?"<svg>":"",a=ae;for(let d=0;d<t;d++){const n=r[d];let c,y,h=-1,g=0;for(;g<n.length&&(a.lastIndex=g,y=a.exec(n),y!==null);)g=a.lastIndex,a===ae?y[1]==="!--"?a=_t:y[1]!==void 0?a=kt:y[2]!==void 0?(Gt.test(y[2])&&(o=RegExp("</"+y[2],"g")),a=W):y[3]!==void 0&&(a=W):a===W?y[0]===">"?(a=o??ae,h=-1):y[1]===void 0?h=-2:(h=a.lastIndex-y[2].length,c=y[1],a=y[3]===void 0?W:y[3]==='"'?At:xt):a===At||a===xt?a=W:a===_t||a===kt?a=ae:(a=W,o=void 0);const w=a===W&&r[d+1].startsWith("/>")?" ":"";s+=a===ae?n+Hi:h>=0?(i.push(c),n.slice(0,h)+Ze+n.slice(h)+L+w):n+L+(h===-2?(i.push(void 0),d):w)}return[Jt(r,s+(r[t]||"<?>")+(e===2?"</svg>":"")),i]};class ve{constructor({strings:e,_$litType$:t},i){let o;this.parts=[];let s=0,a=0;const d=e.length-1,n=this.parts,[c,y]=Oi(e,t);if(this.el=ve.createElement(c,i),q.currentNode=this.el.content,t===2){const h=this.el.content,g=h.firstChild;g.remove(),h.append(...g.childNodes)}for(;(o=q.nextNode())!==null&&n.length<d;){if(o.nodeType===1){if(o.hasAttributes()){const h=[];for(const g of o.getAttributeNames())if(g.endsWith(Ze)||g.startsWith(L)){const w=y[a++];if(h.push(g),w!==void 0){const D=o.getAttribute(w.toLowerCase()+Ze).split(L),B=/([.?@])?(.*)/.exec(w);n.push({type:1,index:s,name:B[2],strings:D,ctor:B[1]==="."?Li:B[1]==="?"?Ui:B[1]==="@"?Fi:Ee})}else n.push({type:6,index:s})}for(const g of h)o.removeAttribute(g)}if(Gt.test(o.tagName)){const h=o.textContent.split(L),g=h.length-1;if(g>0){o.textContent=te?te.emptyScript:"";for(let w=0;w<g;w++)o.append(h[w],Se()),q.nextNode(),n.push({type:2,index:++s});o.append(h[g],Se())}}}else if(o.nodeType===8)if(o.data===Yt)n.push({type:2,index:s});else{let h=-1;for(;(h=o.data.indexOf(L,h+1))!==-1;)n.push({type:7,index:s}),h+=L.length-1}s++}}static createElement(e,t){const i=Z.createElement("template");return i.innerHTML=e,i}}function ie(r,e,t=r,i){var o,s,a,d;if(e===pe)return e;let n=i!==void 0?(o=t._$Co)===null||o===void 0?void 0:o[i]:t._$Cl;const c=ue(e)?void 0:e._$litDirective$;return n?.constructor!==c&&((s=n?._$AO)===null||s===void 0||s.call(n,!1),c===void 0?n=void 0:(n=new c(r),n._$AT(r,t,i)),i!==void 0?((a=(d=t)._$Co)!==null&&a!==void 0?a:d._$Co=[])[i]=n:t._$Cl=n),n!==void 0&&(e=ie(r,n._$AS(r,e.values),n,i)),e}class Di{constructor(e,t){this._$AV=[],this._$AN=void 0,this._$AD=e,this._$AM=t}get parentNode(){return this._$AM.parentNode}get _$AU(){return this._$AM._$AU}u(e){var t;const{el:{content:i},parts:o}=this._$AD,s=((t=e?.creationScope)!==null&&t!==void 0?t:Z).importNode(i,!0);q.currentNode=s;let a=q.nextNode(),d=0,n=0,c=o[0];for(;c!==void 0;){if(d===c.index){let y;c.type===2?y=new Ie(a,a.nextSibling,this,e):c.type===1?y=new c.ctor(a,c.name,c.strings,this,e):c.type===6&&(y=new zi(a,this,e)),this._$AV.push(y),c=o[++n]}d!==c?.index&&(a=q.nextNode(),d++)}return q.currentNode=Z,s}v(e){let t=0;for(const i of this._$AV)i!==void 0&&(i.strings!==void 0?(i._$AI(e,i,t),t+=i.strings.length-2):i._$AI(e[t])),t++}}class Ie{constructor(e,t,i,o){var s;this.type=2,this._$AH=k,this._$AN=void 0,this._$AA=e,this._$AB=t,this._$AM=i,this.options=o,this._$Cp=(s=o?.isConnected)===null||s===void 0||s}get _$AU(){var e,t;return(t=(e=this._$AM)===null||e===void 0?void 0:e._$AU)!==null&&t!==void 0?t:this._$Cp}get parentNode(){let e=this._$AA.parentNode;const t=this._$AM;return t!==void 0&&e?.nodeType===11&&(e=t.parentNode),e}get startNode(){return this._$AA}get endNode(){return this._$AB}_$AI(e,t=this){e=ie(this,e,t),ue(e)?e===k||e==null||e===""?(this._$AH!==k&&this._$AR(),this._$AH=k):e!==this._$AH&&e!==pe&&this._(e):e._$litType$!==void 0?this.g(e):e.nodeType!==void 0?this.$(e):Ri(e)?this.T(e):this._(e)}k(e){return this._$AA.parentNode.insertBefore(e,this._$AB)}$(e){this._$AH!==e&&(this._$AR(),this._$AH=this.k(e))}_(e){this._$AH!==k&&ue(this._$AH)?this._$AA.nextSibling.data=e:this.$(Z.createTextNode(e)),this._$AH=e}g(e){var t;const{values:i,_$litType$:o}=e,s=typeof o=="number"?this._$AC(e):(o.el===void 0&&(o.el=ve.createElement(Jt(o.h,o.h[0]),this.options)),o);if(((t=this._$AH)===null||t===void 0?void 0:t._$AD)===s)this._$AH.v(i);else{const a=new Di(s,this),d=a.u(this.options);a.v(i),this.$(d),this._$AH=a}}_$AC(e){let t=St.get(e.strings);return t===void 0&&St.set(e.strings,t=new ve(e)),t}T(e){Zt(this._$AH)||(this._$AH=[],this._$AR());const t=this._$AH;let i,o=0;for(const s of e)o===t.length?t.push(i=new Ie(this.k(Se()),this.k(Se()),this,this.options)):i=t[o],i._$AI(s),o++;o<t.length&&(this._$AR(i&&i._$AB.nextSibling,o),t.length=o)}_$AR(e=this._$AA.nextSibling,t){var i;for((i=this._$AP)===null||i===void 0||i.call(this,!1,!0,t);e&&e!==this._$AB;){const o=e.nextSibling;e.remove(),e=o}}setConnected(e){var t;this._$AM===void 0&&(this._$Cp=e,(t=this._$AP)===null||t===void 0||t.call(this,e))}}class Ee{constructor(e,t,i,o,s){this.type=1,this._$AH=k,this._$AN=void 0,this.element=e,this.name=t,this._$AM=o,this.options=s,i.length>2||i[0]!==""||i[1]!==""?(this._$AH=Array(i.length-1).fill(new String),this.strings=i):this._$AH=k}get tagName(){return this.element.tagName}get _$AU(){return this._$AM._$AU}_$AI(e,t=this,i,o){const s=this.strings;let a=!1;if(s===void 0)e=ie(this,e,t,0),a=!ue(e)||e!==this._$AH&&e!==pe,a&&(this._$AH=e);else{const d=e;let n,c;for(e=s[0],n=0;n<s.length-1;n++)c=ie(this,d[i+n],t,n),c===pe&&(c=this._$AH[n]),a||(a=!ue(c)||c!==this._$AH[n]),c===k?e=k:e!==k&&(e+=(c??"")+s[n+1]),this._$AH[n]=c}a&&!o&&this.j(e)}j(e){e===k?this.element.removeAttribute(this.name):this.element.setAttribute(this.name,e??"")}}class Li extends Ee{constructor(){super(...arguments),this.type=3}j(e){this.element[this.name]=e===k?void 0:e}}const Vi=te?te.emptyScript:"";class Ui extends Ee{constructor(){super(...arguments),this.type=4}j(e){e&&e!==k?this.element.setAttribute(this.name,Vi):this.element.removeAttribute(this.name)}}class Fi extends Ee{constructor(e,t,i,o,s){super(e,t,i,o,s),this.type=5}_$AI(e,t=this){var i;if((e=(i=ie(this,e,t,0))!==null&&i!==void 0?i:k)===pe)return;const o=this._$AH,s=e===k&&o!==k||e.capture!==o.capture||e.once!==o.once||e.passive!==o.passive,a=e!==k&&(o===k||s);s&&this.element.removeEventListener(this.name,this,o),a&&this.element.addEventListener(this.name,this,e),this._$AH=e}handleEvent(e){var t,i;typeof this._$AH=="function"?this._$AH.call((i=(t=this.options)===null||t===void 0?void 0:t.host)!==null&&i!==void 0?i:this.element,e):this._$AH.handleEvent(e)}}class zi{constructor(e,t,i){this.element=e,this.type=6,this._$AN=void 0,this._$AM=t,this.options=i}get _$AU(){return this._$AM._$AU}_$AI(e){ie(this,e)}}const Ct=Ae.litHtmlPolyfillSupport;Ct?.(ve,Ie),((Fe=Ae.litHtmlVersions)!==null&&Fe!==void 0?Fe:Ae.litHtmlVersions=[]).push("2.8.0");let Ge=class extends C{render(){return u`
...
`,ji=({samples:r,onClick:e,href:t,selected:i})=>{const o=r?T.iaSamples:T.iaPlayer;return u`
    <a href=${t} @click=${()=>e()}>${Be({label:o,selected:i})}</button>
  `},Wi=({samples:r,onClick:e,selected:t})=>{const i=r?T.iaSamples:T.iaPlayer;return u`
    <button @click=${o=>e(o)} class="ia">
      ${Be({label:i,selected:t})}
    </button>
  `},qi=({onClick:r,selected:e})=>u`<button
  @click=${t=>r(t)}
  class="ia-beta"
>
  ${Xt(e)}
</button>`,Ki=({onClick:r,selected:e})=>u`<button
  @click=${t=>r(t)}
  class="sp"
>
  ${ei(e)}
</button>`,Yi=({onClick:r,href:e,selected:t})=>{const i=`${e}?webamp=default`;return u`
    <a href=${i} @click=${o=>r(o)} class="wa">${ti(t)}</button>
  `},Zi=({onClick:r,selected:e})=>u`<button
  @click=${t=>r(t)}
  class="yt"
>
  ${ii(e)}
</button>`,Gi=({samples:r,onClick:e,href:t,selectedOption:i})=>({url:t,selectedHandler:s=>{e(s)},label:Be({label:r?T.iaSamples:T.iaPlayer,selected:i===f.ia}),id:f.ia}),Ji=({samples:r,onClick:e,selectedOption:t})=>({selectedHandler:o=>{e(o)},label:Be({label:r?T.iaSamples:T.iaPlayer,selected:t===f.ia}),id:f.ia}),Qi=({onClick:r,selectedOption:e})=>({selectedHandler:i=>{r(i)},label:Xt(e===f.beta),id:f.beta}),Xi=({onClick:r,selectedOption:e})=>({selectedHandler:i=>{r(i)},label:ei(e===f.spotify),id:f.spotify}),eo=({href:r,onClick:e,selectedOption:t})=>{const i=o=>{e(o)};return{url:`${r}?webamp=default`,selectedHandler:i,label:ti(t===f.webamp),id:f.webamp}},to=({onClick:r,selectedOption:e})=>({selectedHandler:i=>{r(i)},label:ii(e===f.youtube),id:f.youtube}),io=r=>{const{spotify:e,beta:t,youtube:i,selectedOption:o}=r;return[o===f.webamp?Gi(r):Ji(r),t?Qi(r):null,e?Xi(r):null,i?to(r):null,eo(r)].filter(Boolean)};/**
 * @license
 * Copyright 2020 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const{I:oo}=ui,me=(r,e)=>e===void 0?r?._$litType$!==void 0:r?._$litType$===e,Tt=()=>document.createComment(""),Mt=(r,e,t)=>{var i;const o=r._$AA.parentNode,s=e===void 0?r._$AB:e._$AA;if(t===void 0){const a=o.insertBefore(Tt(),s),d=o.insertBefore(Tt(),s);t=new oo(a,d,r,r.options)}else{const a=t._$AB.nextSibling,d=t._$AM,n=d!==r;if(n){let c;(i=t._$AQ)===null||i===void 0||i.call(t,r),t._$AM=r,t._$AP!==void 0&&(c=r._$AU)!==d._$AU&&t._$AP(c)}if(a!==s||n){let c=t._$AA;for(;c!==a;){const y=c.nextSibling;o.insertBefore(c,s),c=y}}}return t},ro={},It=(r,e=ro)=>r._$AH=e,Et=r=>r._$AH,so=r=>{r._$AR()};/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const ao=tt(class extends it{constructor(r){super(r),this.et=new WeakMap}render(r){return[r]}update(r,[e]){if(me(this.it)&&(!me(e)||this.it.strings!==e.strings)){const t=Et(r).pop();let i=this.et.get(this.it.strings);if(i===void 0){const o=document.createDocumentFragment();i=qt(b,o),i.setConnected(!1),this.et.set(this.it.strings,i)}It(i,[t]),Mt(i,void 0,t)}if(me(e)){if(!me(this.it)||this.it.strings!==e.strings){const t=this.et.get(e.strings);if(t!==void 0){const i=Et(t).pop();so(r),Mt(r,void 0,i),It(r,[i])}}this.it=e}else this.it=void 0;return this.render(e)}});/**
 * @license
 * Copyright 2018 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const Bt=r=>r??k;var no=Lt`<svg class="caret-up-svg" viewBox="0 0 8 4" xmlns="http://www.w3.org/2000/svg">
<path d="m6.7226499 3.51689722c.22976435.15317623.54019902.0910893.69337525-.13867505.13615665-.20423497.10222882-.47220946-.06836249-.63681849l-.07031256-.05655675-3.2773501-2.18490007-3.2773501 2.18490007c-.22976434.15317623-.29185128.4636109-.13867505.69337524.13615665.20423498.39656688.27598409.61412572.18182636l.07924953-.04315131 2.7226499-1.81402514z"
  fill=""></path>
</svg>`,lo=Lt`<svg class="caret-down-svg" viewBox="0 0 8 4" xmlns="http://www.w3.org/2000/svg">
<path d="m6.7226499.58397485c.22976435-.15317623.54019902-.09108929.69337525.13867505.13615665.20423498.10222882.47220947-.06836249.63681849l-.07031256.05655676-3.2773501 2.18490006-3.2773501-2.18490006c-.22976434-.15317623-.29185128-.4636109-.13867505-.69337525.13615665-.20423497.39656688-.27598409.61412572-.18182636l.07924953.04315131 2.7226499 1.81402515z"
fill=""></path>
</svg>`;let A=class extends C{constructor(){super(...arguments),this.open=!1,this.isDisabled=!1,this.displayCaret=!1,this.closeOnSelect=!1,this.openViaButton=!0,this.openViaCaret=!0,this.includeSelectedOption=!1,this.selectedOption="",this.options=[],this.optionGroup="options",this.optionSelected=()=>{},this.isCustomList=!1,this.hasCustomClickHandler=!1,this.closeOnEscape=!1,this.closeOnBackdropClick=!1,this.boundKeyboardListener=e=>{switch(e.key){case"Escape":case"Esc":this.closeOptions();break}},this.closeOptions=e=>{e&&e.type==="click"&&e.stopPropagation(),this.open=!1},this.handlingCaretClick=!1}async firstUpdated(){await new Promise(e=>setTimeout(e,0)),this.addEventListener("closeDropdown",this.closeOptions)}disconnectedCallback(){var e;(e=super.disconnectedCallback)===null||e===void 0||e.call(this),this.removeKeyboardListener()}setupKeyboardListener(){this.closeOnEscape&&document.addEventListener("keydown",this.boundKeyboardListener)}removeKeyboardListener(){this.closeOnEscape&&document.removeEventListener("keydown",this.boundKeyboardListener)}get dropdownState(){return this.open?(this.setupKeyboardListener(),"open"):(this.removeKeyboardListener(),"closed")}toggleOptions(){this.open=!this.open}mainButtonClicked(){if(this.handlingCaretClick){this.handlingCaretClick=!1;return}this.openViaButton&&this.toggleOptions()}caretInteracted(){this.openViaCaret&&this.toggleOptions()}caretClicked(){this.handlingCaretClick=!0,this.caretInteracted()}caretKeyDown(e){(e.key==="Enter"||e.key===" ")&&(e.preventDefault(),this.caretInteracted())}renderOption(e){const{label:t,url:i=void 0,id:o}=e;let s;const a=this.selectedOption===o?"selected":"";return i?s=u`<a
        href=${i}
      ...
      >
        ${t}
      </button>`,u`<li class=${a}>${s}</li>`}optionClicked(e,t){var i;e.stopPropagation(),this.selectedOption!==t.id&&(this.selectedOption=t.id,this.dispatchEvent(new CustomEvent("optionSelected",{detail:{option:t}})),(i=t.selectedHandler)===null||i===void 0||i.call(t,t)),this.closeOnSelect&&this.closeOptions()}get availableOptions(){return this.includeSelectedOption?this.options:this.options.filter(e=>this.selectedOption!==e.id)}get caretTemplate(){if(!this.displayCaret)return u``;const e=this.openViaCaret&&!this.openViaButton?"0":void 0,t=this.openViaCaret?"button":void 0;return u`
      <span
        class="caret"
        tabindex=${Bt(e)}
        role=${Bt(t)}
      ...
      >
        <span ?hidden=${!this.open} class="caret-up">
          <slot name="caret-up">${no}</slot>
        </span>
        <span ?hidden=${this.open} class="caret-down">
          <slot name="caret-down">${lo}</slot>
        </span>
      </span>
    `}get dropdownTemplate(){return this.isCustomList?u`<slot name="list"></slot>`:u`${this.availableOptions.map(e=>this.renderOption(e))}`}get backdropTemplate(){return this.closeOnBackdropClick?this.open?u`
      <div
    ...
    `}static get styles(){const e=x`var(--dropdownBorderWidth, 1px)`,t=x`var(--dropdownBorderRadius, 4px)`,i=x`var(--dropdownBorderColor, #fff)`,o=x`var(--dropdownBgColor, #333)`,s=x`var(--dropdownTextColor, #fff)`,a=x`var(--dropdownHoverBgColor, rgba(255, 255, 255, 0.3))`,d=x`var(--dropdownSelectedBgColor, #fff)`;return x`
      :host {
        display: inline;
        color: ${s};
      }
    ...
    `}};l([v({type:Boolean,reflect:!0})],A.prototype,"open",void 0);l([v({type:Boolean,reflect:!0})],A.prototype,"isDisabled",void 0);l([v({type:Boolean})],A.prototype,"displayCaret",void 0);l([v({type:Boolean})],A.prototype,"closeOnSelect",void 0);l([v({type:Boolean})],A.prototype,"openViaButton",void 0);l([v({type:Boolean})],A.prototype,"openViaCaret",void 0);l([v({type:Boolean})],A.prototype,"includeSelectedOption",void 0);l([v({type:String})],A.prototype,"selectedOption",void 0);l([v({attribute:!1})],A.prototype,"options",void 0);l([v({type:String})],A.prototype,"optionGroup",void 0);l([v({attribute:!1})],A.prototype,"optionSelected",void 0);l([v({type:Boolean,reflect:!0})],A.prototype,"isCustomList",void 0);l([v({type:Boolean,reflect:!0})],A.prototype,"hasCustomClickHandler",void 0);l([v({type:Boolean,reflect:!0})],A.prototype,"closeOnEscape",void 0);l([v({type:Boolean,reflect:!0})],A.prototype,"closeOnBackdropClick",void 0);A=l([O("ia-dropdown")],A);const co=x`
  section#radio {
    display: flex;
    flex-direction: row;
    align-items: center;
  ...
  /* End demarcation */
`;var Ce;(function(r){r.postInit="postInit",r.channelChange="channelChange"})(Ce||(Ce={}));let M=class extends C{constructor(){super(...arguments),this.youtube=!1,this.spotify=!1,this.beta=!1,this.webamp=!0,this.samples=!1,this.backgroundTheme="dark",this.selected=f.ia,this.displayStyle="radio",this.url=""}firstUpdated(){this.dispatchEvent(new CustomEvent(Ce.postInit,{detail:{channel:this.selected},composed:!0,bubbles:!0}))}emitChannelChanged(){this.dispatchEvent(new CustomEvent(Ce.channelChange,{detail:{channel:this.selected},composed:!0,bubbles:!0}))}iaClicked(){this.selected!==f.ia&&(this.selected=f.ia,this.emitChannelChanged())}betaClicked(){this.selected!==f.beta&&(this.selected=f.beta,this.emitChannelChanged())}spotifyClicked(){this.selected!==f.spotify&&(this.selected=f.spotify,this.emitChannelChanged())}webampClicked(){this.selected!==f.webamp&&(this.selected=f.webamp,this.emitChannelChanged())}youtubeClicked(){this.selected!==f.youtube&&(this.selected=f.youtube,this.emitChannelChanged())}dropdownOptionSelected(e){this.selected=e.id,this.emitChannelChanged(),this.iaDropdown.open=!1}get iaLinkSelector(){const e=this.selected===f.ia?"selected":"";return u`
      <li class=${e}>
        ${ji({samples:this.samples,selected:this.selected===f.ia,onClick:()=>this.iaClicked(),href:this.url})}
      </li>
    `}get iaButtonSelector(){const e=this.selected===f.ia?"selected":"";return u`
      <li class=${e}>
        ${Wi({samples:this.samples,selected:this.selected===f.ia,onClick:()=>this.iaClicked()})}
      </li>
    `}get iaBetaSelector(){const e=this.selected===f.beta?"selected":"";return u`
      <li class=${e}>
        ${qi({selected:this.selected===f.beta,onClick:()=>this.betaClicked()})}
      </li>
    `}get spotifySelector(){const e=this.selected===f.spotify?"selected":"";return u`
      <li class=${e}>
        ${Ki({selected:this.selected===f.spotify,onClick:()=>this.spotifyClicked()})}
      </li>
    `}get webampSelector(){const e=this.selected===f.webamp?"selected":"";return u`
      <li class=${e}>
        ${Yi({href:this.url||window.location.href,selected:this.selected===f.webamp,onClick:()=>this.webampClicked()})}
      </li>
    `}get youtubeSelector(){const e=this.selected===f.youtube?"selected":"";return u`
      <li class=${e}>
        ${Zi({selected:this.selected===f.youtube,onClick:()=>this.youtubeClicked()})}
      </li>
    `}get properIaSelector(){return this.selected===f.webamp?this.iaLinkSelector:this.iaButtonSelector}toggleDisplayStyle(){const e=this.displayStyle==="dropdown"?"radio":"dropdown";this.displayStyle=e}shouldShowChannelType(e){const t=this.selected===e;return this.displayStyle==="radio"?!0:!(this.displayStyle==="dropdown"&&t)}get dropdownOptions(){const{samples:e,beta:t,spotify:i,webamp:o,youtube:s,url:a,selected:d}=this;return io({selectedOption:d,samples:!!e,beta:t,spotify:i,webamp:o,youtube:s,href:a,onClick:this.dropdownOptionSelected.bind(this)})}get currentlySelectedIcon(){switch(this.selected){case f.beta:return P.beta;case f.spotify:return P.spotify;case f.youtube:return P.youtube;case f.webamp:return P.webamp;default:return P.ia}}get dropdown(){return u`
      <ia-dropdown
        displayCaret
    ...
    `}render(){return u`
      ...
      >
        ${ao(this.displayStyle==="radio"?this.radioView:this.dropdown)}
      </section>
    `}};M.styles=[x`
      :host {
        display: block;
    ...
    `,co];l([v({attribute:!0,type:Boolean,reflect:!0})],M.prototype,"youtube",void 0);l([v({attribute:!0,type:Boolean,reflect:!0})],M.prototype,"spotify",void 0);l([v({attribute:!0,type:Boolean,reflect:!0})],M.prototype,"beta",void 0);l([v({attribute:!0,type:Boolean,reflect:!0})],M.prototype,"webamp",void 0);l([v({attribute:!0,type:Boolean,reflect:!0})],M.prototype,"samples",void 0);l([v({attribute:!0,type:String,reflect:!0})],M.prototype,"backgroundTheme",void 0);l([v({type:String,reflect:!0})],M.prototype,"selected",void 0);l([v({type:String,reflect:!0})],M.prototype,"displayStyle",void 0);l([v({type:String})],M.prototype,"url",void 0);l([F("ia-dropdown")],M.prototype,"iaDropdown",void 0);M=l([O("channel-selector")],M);let Te=class extends C{constructor(){super(...arguments),this.iaUrn=""}get spotifyUrl(){return!this.iaUrn||!this.iaUrn.match(/urn:spotify:/g)?"":`https://open.spotify.com/embed/${this.iaUrn.replace(/urn:spotify:/g,"").replace(/:/g,"/")}`}render(){const e=this.spotifyUrl;return e?u`
      <iframe
        id="embed-iframe"
        src="${e}"
        width="100%"
      ...
      ></iframe>
    `:u`<h3>Invalid Spotify URI: ${this.iaUrn}</h3>`}static get styles(){return[x`
        :host {
          display: block;
          width: 100%;
          height: 100%;
        }
      `]}};l([v({type:String,attribute:!0,reflect:!0})],Te.prototype,"iaUrn",void 0);l([F("iframe")],Te.prototype,"iframe",void 0);Te=l([O("spotify-player")],Te);let oe=class extends C{constructor(){super(...arguments),this.iaUrn="",this.display=!1,this.baseHost="https://archive.org"}get youTubeUrl(){if(!this.iaUrn||!this.iaUrn.match(/urn:youtube:/g))return"";const t=this.iaUrn.replace(/urn:youtube:/g,"").replace(/:/g,"/"),i=`origin=${this.baseHost}&widgetid=1&autoplay=1&rel=0`;return`https://www.youtube.com/embed/${t}?${i}`}render(){const e=this.youTubeUrl;return e?u`
      <iframe
        id="embed-iframe"
        src="${e}"
        width="100%"
    ...
    `}async albumInfo(){this.errorMsg="";try{const e=await fetch(`https://archive.org/metadata/${this.albumId}`).then(i=>i.json()),t=await fetch(`https://archive.org/services/playlist/${this.albumId}`).then(i=>i.json());this.albumPlaylist=t,this.albumMd=new et(e),this.album=new uo(e,this.albumPlaylist),window.Album=this.album}catch(e){this.errorMsg=e.message}}formInputSubmit(e){e.preventDefault(),this.albumId=this.input.value}get albumStats(){if(!this.album)return b;const e=this.album.spotifyTracks.reduce((i,o)=>(i.push(Number.isInteger(o?.track)?`${o?.track}`:"n/a"),i),[]).join(", "),t=this.album.youtubeTracks.reduce((i,o)=>(i.push(Number.isInteger(o?.track)?`${o?.track}`:"n/a"),i),[]).join(", ");return u`
            ...
            <dd>
              ...
              <div>
                ...
                ${this.album.spotifyTracks.map(i=>u`
                      <button
                        @click=${()=>this.displayTrack(i,f.spotify)}
                      >
                        ${i.track} - ${i.title}
                      </button>
                    `)}
              ...
              <div>
                ...
                ${this.album.youtubeTracks.map(i=>u`
                      <button
                        @click=${()=>this.displayTrack(i,f.youtube)}
                      >
                        ${i.track} - ${i.title}
                      </button>
                    `)}
    ...
    `}displayTrack(e,t){console.log("Displaying track: ",{track:e,channelType:t}),this.selectedTrack=e}get demoClicks(){return u`
      <section id="demo-clicks">
        ${po.map(e=>{const t=this.albumId===e.id;return u`
    ...
    `}get channelSelectors(){const e=`${location.origin}/demo`;return u`
      <section id="components">
        <channel-selector
          ...
          beta
          samples
          .selected=${this.startAtWebamp?f.webamp:this.selectedByRadio}
        ...
        <channel-selector
          ...
          .selected=${this.startAtWebamp?f.webamp:this.selectedByDropdown?this.selectedByDropdown:f.beta}
        >
        </channel-selector>
  ...
  `;l([v({type:String,reflect:!0})],_.prototype,"viewToShow",void 0);l([v({type:String})],_.prototype,"selectedByDropdown",void 0);l([v({type:String})],_.prototype,"errorMsg",void 0);l([v({type:String})],_.prototype,"selectedByDropdownOnload",void 0);l([v({type:String})],_.prototype,"selectedByRadio",void 0);l([v({type:String})],_.prototype,"selectedByRadioOnload",void 0);l([v({type:String})],_.prototype,"albumId",void 0);l([v({type:String})],_.prototype,"bgColor",void 0);l([v({type:Object,attribute:!1})],_.prototype,"albumMd",void 0);l([v({type:Object,attribute:!1})],_.prototype,"albumPlaylist",void 0);l([v({type:Object,attribute:!1})],_.prototype,"album",void 0);l([v({type:String})],_.prototype,"componentToShow",void 0);l([F("input#md-search")],_.prototype,"input",void 0);l([F("iaux-photo-viewer")],_.prototype,"photoViewerEl",void 0);l([v({type:Object})],_.prototype,"selectedTrack",void 0);l([v({type:Boolean})],_.prototype,"signedIn",void 0);l([v({type:String})],_.prototype,"photoDisplay",void 0);_=l([O("app-root")],_);
