 ...
 * Copyright 2018 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const rt=tt(class extends it{constructor(r){var e;if(super(r),r.type!==Qt.ATTRIBUTE||r.name!=="class"||((e=r.strings)===null||e===void 0?void 0:e.length)>2)throw Error("`classMap()` can only be used in the `class` attribute and must be the only part in the attribute.")}render(r){return" "+Object.keys(r).filter(e=>r[e]).join(" ")+" "}update(r,[e]){var t,i;if(this.nt===void 0){this.nt=new Set,r.strings!==void 0&&(this.st=new Set(r.strings.join(" ").split(/\s/).filter(s=>s!=="")));for(const s in e)e[s]&&!(!((t=this.st)===null||t===void 0)&&t.has(s))&&this.nt.add(s);return this.render(e)}const o=r.element.classList;this.nt.forEach(s=>{s in e||(o.remove(s),this.nt.delete(s))});for(const s in e){const a=!!e[s];a===this.nt.has(s)||((i=this.st)===null||i===void 0?void 0:i.has(s))||(a?(o.add(s),this.nt.add(s)):(o.remove(s),this.nt.delete(s)))}return U}});var m;(function(r){r.ia="ia",r.beta="beta",r.youtube="youtube",r.spotify="spotify",r.webamp="webamp"})(m||(m={}));var T;(function(r){r.iaSamples="Samples",r.iaPlayer="Player",r.beta="Beta",r.spotify="Spotify",r.webamp="Webamp",r.youtube="YouTube"})(T||(T={}));const P={ia:u`<img
    class="ia"
...
>
  ${ii(e)}
</button>`,Gi=({samples:r,onClick:e,href:t,selectedOption:i})=>({url:t,selectedHandler:s=>{e(s)},label:Be({label:r?T.iaSamples:T.iaPlayer,selected:i===m.ia}),id:m.ia}),Ji=({samples:r,onClick:e,selectedOption:t})=>({selectedHandler:o=>{e(o)},label:Be({label:r?T.iaSamples:T.iaPlayer,selected:t===m.ia}),id:m.ia}),Qi=({onClick:r,selectedOption:e})=>({selectedHandler:i=>{r(i)},label:Xt(e===m.beta),id:m.beta}),Xi=({onClick:r,selectedOption:e})=>({selectedHandler:i=>{r(i)},label:ei(e===m.spotify),id:m.spotify}),eo=({href:r,onClick:e,selectedOption:t})=>{const i=o=>{e(o)};return{url:`${r}?webamp=default`,selectedHandler:i,label:ti(t===m.webamp),id:m.webamp}},to=({onClick:r,selectedOption:e})=>({selectedHandler:i=>{r(i)},label:ii(e===m.youtube),id:m.youtube}),io=r=>{const{spotify:e,beta:t,youtube:i,selectedOption:o}=r;return[o===m.webamp?Gi(r):Ji(r),t?Qi(r):null,e?Xi(r):null,i?to(r):null,eo(r)].filter(Boolean)};/**
 * @license
 * Copyright 2020 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const{I:oo}=ui,fe=(r,e)=>e===void 0?r?._$litType$!==void 0:r?._$litType$===e,Tt=()=>document.createComment(""),Mt=(r,e,t)=>{var i;const o=r._$AA.parentNode,s=e===void 0?r._$AB:e._$AA;if(t===void 0){const a=o.insertBefore(Tt(),s),d=o.insertBefore(Tt(),s);t=new oo(a,d,r,r.options)}else{const a=t._$AB.nextSibling,d=t._$AM,n=d!==r;if(n){let c;(i=t._$AQ)===null||i===void 0||i.call(t,r),t._$AM=r,t._$AP!==void 0&&(c=r._$AU)!==d._$AU&&t._$AP(c)}if(a!==s||n){let c=t._$AA;for(;c!==a;){const y=c.nextSibling;o.insertBefore(c,s),c=y}}}return t},ro={},It=(r,e=ro)=>r._$AH=e,Et=r=>r._$AH,so=r=>{r._$AR()};/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const ao=tt(class extends it{constructor(r){super(r),this.et=new WeakMap}render(r){return[r]}update(r,[e]){if(fe(this.it)&&(!fe(e)||this.it.strings!==e.strings)){const t=Et(r).pop();let i=this.et.get(this.it.strings);if(i===void 0){const o=document.createDocumentFragment();i=qt(b,o),i.setConnected(!1),this.et.set(this.it.strings,i)}It(i,[t]),Mt(i,void 0,t)}if(fe(e)){if(!fe(this.it)||this.it.strings!==e.strings){const t=this.et.get(e.strings);if(t!==void 0){const i=Et(t).pop();so(r),Mt(r,void 0,i),It(r,[i])}}this.it=e}else this.it=void 0;return this.render(e)}});/**
 * @license
 * Copyright 2018 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
...
fill=""></path>
      ...
      >
        ${t}
      </button>`,u`<li class=${a}>${s}</li>`}optionClicked(e){var t;this.selectedOption!==e.id&&(this.selectedOption=e.id,this.dispatchEvent(new CustomEvent("optionSelected",{detail:{option:e}})),(t=e.selectedHandler)===null||t===void 0||t.call(e,e)),this.closeOnSelect&&this.closeOptions()}get availableOptions(){return this.includeSelectedOption?this.options:this.options.filter(e=>this.selectedOption!==e.id)}get caretTemplate(){if(!this.displayCaret)return u``;const e=this.openViaCaret&&!this.openViaButton?"0":void 0,t=this.openViaCaret?"button":void 0;return u`
      <span
        class="caret"
        tabindex=${Bt(e)}
        role=${Bt(t)}
  ...
  /* End demarcation */
`;var Ce;(function(r){r.postInit="postInit",r.channelChange="channelChange"})(Ce||(Ce={}));let M=class extends C{constructor(){super(...arguments),this.youtube=!1,this.spotify=!1,this.beta=!1,this.webamp=!0,this.samples=!1,this.backgroundTheme="dark",this.selected=m.ia,this.displayStyle="radio",this.url=""}firstUpdated(){this.dispatchEvent(new CustomEvent(Ce.postInit,{detail:{channel:this.selected},composed:!0,bubbles:!0}))}emitChannelChanged(){this.dispatchEvent(new CustomEvent(Ce.channelChange,{detail:{channel:this.selected},composed:!0,bubbles:!0}))}iaClicked(){this.selected!==m.ia&&(this.selected=m.ia,this.emitChannelChanged())}betaClicked(){this.selected!==m.beta&&(this.selected=m.beta,this.emitChannelChanged())}spotifyClicked(){this.selected!==m.spotify&&(this.selected=m.spotify,this.emitChannelChanged())}webampClicked(){this.selected!==m.webamp&&(this.selected=m.webamp,this.emitChannelChanged())}youtubeClicked(){this.selected!==m.youtube&&(this.selected=m.youtube,this.emitChannelChanged())}dropdownOptionSelected(e){this.selected=e.id,this.emitChannelChanged(),this.iaDropdown.open=!1}get iaLinkSelector(){const e=this.selected===m.ia?"selected":"";return u`
      <li class=${e}>
        ${ji({samples:this.samples,selected:this.selected===m.ia,onClick:()=>this.iaClicked(),href:this.url})}
      </li>
    `}get iaButtonSelector(){const e=this.selected===m.ia?"selected":"";return u`
      <li class=${e}>
        ${Wi({samples:this.samples,selected:this.selected===m.ia,onClick:()=>this.iaClicked()})}
      </li>
    `}get iaBetaSelector(){const e=this.selected===m.beta?"selected":"";return u`
      <li class=${e}>
        ${qi({selected:this.selected===m.beta,onClick:()=>this.betaClicked()})}
      </li>
    `}get spotifySelector(){const e=this.selected===m.spotify?"selected":"";return u`
      <li class=${e}>
        ${Ki({selected:this.selected===m.spotify,onClick:()=>this.spotifyClicked()})}
      </li>
    `}get webampSelector(){const e=this.selected===m.webamp?"selected":"";return u`
      <li class=${e}>
        ${Yi({href:this.url||window.location.href,selected:this.selected===m.webamp,onClick:()=>this.webampClicked()})}
      </li>
    `}get youtubeSelector(){const e=this.selected===m.youtube?"selected":"";return u`
      <li class=${e}>
        ${Zi({selected:this.selected===m.youtube,onClick:()=>this.youtubeClicked()})}
      </li>
    `}get properIaSelector(){return this.selected===m.webamp?this.iaLinkSelector:this.iaButtonSelector}toggleDisplayStyle(){const e=this.displayStyle==="dropdown"?"radio":"dropdown";this.displayStyle=e}shouldShowChannelType(e){const t=this.selected===e;return this.displayStyle==="radio"?!0:!(this.displayStyle==="dropdown"&&t)}get dropdownOptions(){const{samples:e,beta:t,spotify:i,webamp:o,youtube:s,url:a,selected:d}=this;return io({selectedOption:d,samples:!!e,beta:t,spotify:i,webamp:o,youtube:s,href:a,onClick:this.dropdownOptionSelected.bind(this)})}get currentlySelectedIcon(){switch(this.selected){case m.beta:return P.beta;case m.spotify:return P.spotify;case m.youtube:return P.youtube;case m.webamp:return P.webamp;default:return P.ia}}get dropdown(){return u`
      <ia-dropdown
        displayCaret
            ...
            <dd>
              ...
              <div>
                ...
                ${this.album.spotifyTracks.map(i=>u`
                      <button
                        @click=${()=>this.displayTrack(i,m.spotify)}
                      >
                        ${i.track} - ${i.title}
                      </button>
                    `)}
              ...
              <div>
                ...
                ${this.album.youtubeTracks.map(i=>u`
                      <button
                        @click=${()=>this.displayTrack(i,m.youtube)}
                      >
                        ${i.track} - ${i.title}
                      </button>
                    `)}
    ...
    `}get channelSelectors(){const e=`${location.origin}/demo`;return u`
      <section id="components">
        <channel-selector
          ...
          beta
          samples
          .selected=${this.startAtWebamp?m.webamp:this.selectedByRadio}
        ...
        <channel-selector
          ...
          .selected=${this.startAtWebamp?m.webamp:this.selectedByDropdown?this.selectedByDropdown:m.beta}
        >
        </channel-selector>
