...
`;class jt extends S{static get styles(){return E`
      :host {
    ...
    `}render(){return zt}}customElements.define("ia-icon-audio",jt);var Wt=h`
<svg
  viewBox="0 0 40 40"
  xmlns="http://www.w3.org/2000/svg"
...
`;class qt extends S{static get styles(){return E`
      :host {
        width: var(--iconWidth, 'auto');
        height: var(--iconHeight, 'auto');
      }
    ...
    `}render(){return Wt}}customElements.define("ia-icon-texts",qt);function Yt(){return{el:"#BookReader",showToolbar:!1,onePage:{autofit:"height"},enableFSLogoShortcut:!0,enableBookmarks:!0,enablePageResume:!1,enableTtsPlugin:!1,enableUrlPlugin:!1,defaults:"mode/1up",enableSearch:!0,searchInsideUrl:"/fulltext/inside.php",initialSearchTerm:null,imagesBaseURL:"/bookreader/BookReader/images/",defaultStartLeaf:0,titleLeaf:0,controls:{twoPage:{visible:!1},viewmode:{visible:!1}},bookType:"linerNotes"}}function Zt(r){var e;const i={...r?.brOptions,...Yt()},o=new window.BookReader(i),s=window.BookReader.prototype.getPageURI;o.getPageURI=(d,n=1,v=0)=>{const w=Math.pow(2,Math.floor(Math.log2(Math.max(1,n))));let m=s.call(o,d,w,v);return m+=m.indexOf("?")>-1?"&":"?",m=`${m}scale=${w}&rotate=${v}`,console.log("URI -----",m),m},window.br=o;const a=(e=r?.data)===null||e===void 0?void 0:e.isRestricted;return window.dispatchEvent(new CustomEvent("contextmenu",{detail:{isRestricted:a}})),o}let $=class extends S{constructor(){super(...arguments),this.showAllPhotos=!1,this.baseHost="archive.org",this.signedIn=!1,this.itemIdentifier="",this.looseImages=[],this.fullscreenActive=!1,this.brInitialized=!1,this.bindBrEvents=()=>{window.addEventListener("BookReader:PostInit",e=>{var t;console.log("BookReader:PostInit BookReader:PostInit",e,this.bookreader),this.bookreader=(t=e)===null||t===void 0?void 0:t.detail.props,window.br=this.bookreader,setTimeout(()=>{var i,o;(i=this.bookreader)===null||i===void 0||i.jumpToIndex(0),(o=this.bookreader)===null||o===void 0||o.resize(),console.log("POST INIT TIMEOUT RESIZED & JUMPED TO INDEX 00000")},1e3)}),window.addEventListener("BrBookNav:PostInit",e=>{console.log("BookNav:PostInit",e,this.bookreader),setTimeout(()=>{var t;this.brInitialized||(console.log("BR WILL INIT NOW"),(t=this.bookreader)===null||t===void 0||t.init(),this.brInitialized=!0),console.log("BR WILL NOT NOT NOT INIT NOW")},0)}),window.addEventListener("BookReader:fullscreenToggled",()=>{var e;this.fullscreenActive=((e=this.bookreader)===null||e===void 0?void 0:e.isFullscreen())||!1})}}firstUpdated(){console.log("FIRST UPDATED"),this.bindBrEvents()}updated(e){var t;e.has("showAllPhotos")&&this.showAllPhotos&&this.linerNotesManifest&&(this.prepareLightDomHook(),this.loadFreshBookReaderFromManifest()),this.linerNotesManifest&&(e.has("lightDomHook")&&this.lightDomHook||e.has("linerNotesManifest"))&&(this.prepareLightDomHook(),this.loadFreshBookReaderFromManifest()),e.has("looseImages")&&((t=this.looseImages)===null||t===void 0?void 0:t.length)&&this.loadImages()}render(){var e,t;return console.log("*** RENDER  itemIdentifier ",this.itemIdentifier),((e=this.looseImages)===null||e===void 0?void 0:e.length)===1?h`<img
      ...
      />`:this.showAllPhotos&&this.linerNotesManifest?h`
          <div
            class=${`photo-viewer-container ${this.fullscreenActive?"fullscreenActive":""}`}
          >
            <button
 ...
 */const ci=Te(class extends Pe{constructor(r){super(r),this.et=new WeakMap}render(r){return[r]}update(r,[e]){if(re(this.it)&&(!re(e)||this.it.strings!==e.strings)){const t=tt(r).pop();let i=this.et.get(this.it.strings);if(i===void 0){const o=document.createDocumentFragment();i=lt(g,o),i.setConnected(!1),this.et.set(this.it.strings,i)}et(i,[t]),Xe(i,void 0,t)}if(re(e)){if(!re(this.it)||this.it.strings!==e.strings){const t=this.et.get(e.strings);if(t!==void 0){const i=tt(t).pop();ui(r),Xe(r,void 0,i),et(r,[i])}}this.it=e}else this.it=void 0;return this.render(e)}});let B=class extends S{constructor(){super(...arguments),this.open=!1,this.displayCaret=!1,this.selectedOption="",this.options=[],this.optionGroup="options",this.optionSelected=()=>{}}renderOption(e){const{label:t,url:i=void 0,id:o}=e;let s;const a=this.selectedOption===o?"selected":"";return i?s=h`<a
  ...
  /* End demarcation */
`;var ue;(function(r){r.postInit="postInit",r.channelChange="channelChange"})(ue||(ue={}));let x=class extends S{constructor(){super(...arguments),this.youtube=!1,this.spotify=!1,this.beta=!1,this.webamp=!0,this.samples=!1,this.backgroundTheme="dark",this.selected=p.ia,this.displayStyle="radio",this.url=""}firstUpdated(){this.dispatchEvent(new CustomEvent(ue.postInit,{detail:{channel:this.selected},composed:!0,bubbles:!0}))}emitChannelChanged(){this.dispatchEvent(new CustomEvent(ue.channelChange,{detail:{channel:this.selected},composed:!0,bubbles:!0}))}iaClicked(){this.selected!==p.ia&&(this.selected=p.ia,this.emitChannelChanged())}betaClicked(){this.selected!==p.beta&&(this.selected=p.beta,this.emitChannelChanged())}spotifyClicked(){this.selected!==p.spotify&&(this.selected=p.spotify,this.emitChannelChanged())}webampClicked(){this.selected!==p.webamp&&(this.selected=p.webamp,this.emitChannelChanged())}youtubeClicked(){this.selected!==p.youtube&&(this.selected=p.youtube,this.emitChannelChanged())}dropdownOptionSelected(e){this.selected=e.id,this.emitChannelChanged(),this.iaDropdown.open=!1}get iaLinkSelector(){const e=this.selected===p.ia?"selected":"";return h`
      <li class=${e}>
    ...
    `,hi];l([f({attribute:!0,type:Boolean,reflect:!0})],x.prototype,"youtube",void 0);l([f({attribute:!0,type:Boolean,reflect:!0})],x.prototype,"spotify",void 0);l([f({attribute:!0,type:Boolean,reflect:!0})],x.prototype,"beta",void 0);l([f({attribute:!0,type:Boolean,reflect:!0})],x.prototype,"webamp",void 0);l([f({attribute:!0,type:Boolean,reflect:!0})],x.prototype,"samples",void 0);l([f({attribute:!0,type:String,reflect:!0})],x.prototype,"backgroundTheme",void 0);l([f({type:String,reflect:!0})],x.prototype,"selected",void 0);l([f({type:String,reflect:!0})],x.prototype,"displayStyle",void 0);l([f({type:String})],x.prototype,"url",void 0);l([ce("ia-dropdown")],x.prototype,"iaDropdown",void 0);x=l([H("iaux-channel-selector")],x);let X=class extends S{constructor(){super(...arguments),this.iaSpotifyUrn="",this.display=!1}get spotifyUrl(){return!this.iaSpotifyUrn||!this.iaSpotifyUrn.match(/urn:spotify:/g)?"":`https://open.spotify.com/embed/${this.iaSpotifyUrn.replace(/urn:spotify:/g,"").replace(/:/g,"/")}`}render(){const e=this.spotifyUrl;return e?h`
      <iframe
        id="embed-iframe"
        src="${e}"
        width="100%"
    ...
    `:h`<h3>Invalid Spotify URI: ${this.iaSpotifyUrn}</h3>`}static get styles(){return[E`
      ...
      `]}};l([f({type:String,reflect:!0})],X.prototype,"iaSpotifyUrn",void 0);l([f({type:Boolean,reflect:!0})],X.prototype,"display",void 0);l([ce("iframe")],X.prototype,"iframe",void 0);X=l([H("spotify-player")],X);let q=class extends S{constructor(){super(...arguments),this.iaYouTubeUrn="",this.display=!1,this.baseHost="https://archive.org"}get youTubeUrl(){if(!this.iaYouTubeUrn||!this.iaYouTubeUrn.match(/urn:youtube:/g))return"";const t=this.iaYouTubeUrn.replace(/urn:youtube:/g,"").replace(/:/g,"/"),i=`origin=${this.baseHost}&widgetid=1&autoplay=1&rel=0`;return`https://www.youtube.com/embed/${t}?${i}`}render(){const e=this.youTubeUrl;return e?h`
      <iframe
        id="embed-iframe"
        src="${e}"
        width="100%"
    ...
    `}get demoClicks(){return h`
      <section id="demo-clicks">
        ${fi.map(e=>{const t=this.albumId===e.id;return h`
  ...
  `;l([f({type:String,reflect:!0})],_.prototype,"viewToShow",void 0);l([f({type:String})],_.prototype,"selectedByDropdown",void 0);l([f({type:String})],_.prototype,"errorMsg",void 0);l([f({type:String})],_.prototype,"selectedByDropdownOnload",void 0);l([f({type:String})],_.prototype,"selectedByRadio",void 0);l([f({type:String})],_.prototype,"selectedByRadioOnload",void 0);l([f({type:String})],_.prototype,"albumId",void 0);l([f({type:String})],_.prototype,"bgColor",void 0);l([f({type:Object,attribute:!1})],_.prototype,"albumMd",void 0);l([f({type:Object,attribute:!1})],_.prototype,"albumPlaylist",void 0);l([f({type:Object,attribute:!1})],_.prototype,"album",void 0);l([f({type:String})],_.prototype,"componentToShow",void 0);l([ce("input#md-search")],_.prototype,"input",void 0);l([f({type:Boolean})],_.prototype,"signedIn",void 0);l([f({type:String})],_.prototype,"photoDisplay",void 0);_=l([H("app-root")],_);
