 ...
 * Copyright 2018 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const Re=Te(class extends Pe{constructor(r){var e;if(super(r),r.type!==mt.ATTRIBUTE||r.name!=="class"||((e=r.strings)===null||e===void 0?void 0:e.length)>2)throw Error("`classMap()` can only be used in the `class` attribute and must be the only part in the attribute.")}render(r){return" "+Object.keys(r).filter(e=>r[e]).join(" ")+" "}update(r,[e]){var t,i;if(this.nt===void 0){this.nt=new Set,r.strings!==void 0&&(this.st=new Set(r.strings.join(" ").split(/\s/).filter(s=>s!=="")));for(const s in e)e[s]&&!(!((t=this.st)===null||t===void 0)&&t.has(s))&&this.nt.add(s);return this.render(e)}const o=r.element.classList;this.nt.forEach(s=>{s in e||(o.remove(s),this.nt.delete(s))});for(const s in e){const a=!!e[s];a===this.nt.has(s)||((i=this.st)===null||i===void 0?void 0:i.has(s))||(a?(o.add(s),this.nt.add(s)):(o.remove(s),this.nt.delete(s)))}return D}});var p;(function(r){r.ia="ia",r.beta="beta",r.youtube="youtube",r.spotify="spotify",r.webamp="webamp"})(p||(p={}));var S;(function(r){r.iaSamples="Samples",r.iaPlayer="Player",r.beta="Beta",r.spotify="Spotify",r.webamp="Webamp",r.youtube="YouTube"})(S||(S={}));const E={ia:u`<img
    class="ia"
  ...
  />`},pe=({label:r=S.iaPlayer,selected:e})=>{const i=Be({filter:e?"invert(1)":"invert(0)",height:"20px",width:"20px"}),o=Re({selected:e,"invert-icon-at-hover-selected":e});return u`
...
`,Gt=({samples:r,onClick:e,href:t,selected:i})=>{const o=r?S.iaSamples:S.iaPlayer;return u`
    <a href=${t} @click=${()=>e()}>${pe({label:o,selected:i})}</button>
  `},Xt=({samples:r,onClick:e,selected:t})=>{const i=r?S.iaSamples:S.iaPlayer;return u`
...
>
  ${bt(e)}
</button>`,ri=({samples:r,onClick:e,href:t,selectedOption:i})=>({url:t,selectedHandler:s=>{e(s)},label:pe({label:r?S.iaSamples:S.iaPlayer,selected:i===p.ia}),id:p.ia}),oi=({samples:r,onClick:e,selectedOption:t})=>({selectedHandler:o=>{e(o)},label:pe({label:r?S.iaSamples:S.iaPlayer,selected:t===p.ia}),id:p.ia}),si=({onClick:r,selectedOption:e})=>({selectedHandler:i=>{r(i)},label:gt(e===p.beta),id:p.beta}),ai=({onClick:r,selectedOption:e})=>({selectedHandler:i=>{r(i)},label:yt(e===p.spotify),id:p.spotify}),ni=({href:r,onClick:e,selectedOption:t})=>{const i=o=>{e(o)};return{url:`${r}?webamp=default`,selectedHandler:i,label:wt(t===p.webamp),id:p.webamp}},li=({onClick:r,selectedOption:e})=>({selectedHandler:i=>{r(i)},label:bt(e===p.youtube),id:p.youtube}),di=r=>{const{spotify:e,beta:t,youtube:i,selectedOption:o}=r;return[o===p.webamp?ri(r):oi(r),t?si(r):null,e?ai(r):null,i?li(r):null,ni(r)].filter(Boolean)};/**
 * @license
 ...
 */const pi=Te(class extends Pe{constructor(r){super(r),this.et=new WeakMap}render(r){return[r]}update(r,[e]){if(re(this.it)&&(!re(e)||this.it.strings!==e.strings)){const t=tt(r).pop();let i=this.et.get(this.it.strings);if(i===void 0){const o=document.createDocumentFragment();i=lt(g,o),i.setConnected(!1),this.et.set(this.it.strings,i)}et(i,[t]),Qe(i,void 0,t)}if(re(e)){if(!re(this.it)||this.it.strings!==e.strings){const t=this.et.get(e.strings);if(t!==void 0){const i=tt(t).pop();hi(r),Qe(r,void 0,i),et(r,[i])}}this.it=e}else this.it=void 0;return this.render(e)}});let B=class extends ${constructor(){super(...arguments),this.open=!1,this.displayCaret=!1,this.selectedOption="",this.options=[],this.optionGroup="options",this.optionSelected=()=>{}}renderOption(e){const{label:t,url:i=void 0,id:o}=e;let s;const a=this.selectedOption===o?"selected":"";return i?s=u`<a
  ...
  /* End demarcation */
`;var ce;(function(r){r.postInit="postInit",r.channelChange="channelChange"})(ce||(ce={}));let x=class extends ${constructor(){super(...arguments),this.youtube=!1,this.spotify=!1,this.beta=!1,this.webamp=!0,this.samples=!1,this.backgroundTheme="dark",this.selected=p.ia,this.displayStyle="radio",this.url=""}firstUpdated(){this.dispatchEvent(new CustomEvent(ce.postInit,{detail:{channel:this.selected},composed:!0,bubbles:!0}))}emitChannelChanged(){this.dispatchEvent(new CustomEvent(ce.channelChange,{detail:{channel:this.selected},composed:!0,bubbles:!0}))}iaClicked(){this.selected!==p.ia&&(this.selected=p.ia,this.emitChannelChanged())}betaClicked(){this.selected!==p.beta&&(this.selected=p.beta,this.emitChannelChanged())}spotifyClicked(){this.selected!==p.spotify&&(this.selected=p.spotify,this.emitChannelChanged())}webampClicked(){this.selected!==p.webamp&&(this.selected=p.webamp,this.emitChannelChanged())}youtubeClicked(){this.selected!==p.youtube&&(this.selected=p.youtube,this.emitChannelChanged())}dropdownOptionSelected(e){this.selected=e.id,this.emitChannelChanged(),this.iaDropdown.open=!1}get iaLinkSelector(){const e=this.selected===p.ia?"selected":"";return u`
      <li class=${e}>
    ...
    `,vi];l([f({attribute:!0,type:Boolean,reflect:!0})],x.prototype,"youtube",void 0);l([f({attribute:!0,type:Boolean,reflect:!0})],x.prototype,"spotify",void 0);l([f({attribute:!0,type:Boolean,reflect:!0})],x.prototype,"beta",void 0);l([f({attribute:!0,type:Boolean,reflect:!0})],x.prototype,"webamp",void 0);l([f({attribute:!0,type:Boolean,reflect:!0})],x.prototype,"samples",void 0);l([f({attribute:!0,type:String,reflect:!0})],x.prototype,"backgroundTheme",void 0);l([f({type:String,reflect:!0})],x.prototype,"selected",void 0);l([f({type:String,reflect:!0})],x.prototype,"displayStyle",void 0);l([f({type:String})],x.prototype,"url",void 0);l([ue("ia-dropdown")],x.prototype,"iaDropdown",void 0);x=l([L("channel-selector")],x);let Q=class extends ${constructor(){super(...arguments),this.iaSpotifyUrn="",this.display=!1}get spotifyUrl(){return!this.iaSpotifyUrn||!this.iaSpotifyUrn.match(/urn:spotify:/g)?"":`https://open.spotify.com/embed/${this.iaSpotifyUrn.replace(/urn:spotify:/g,"").replace(/:/g,"/")}`}render(){const e=this.spotifyUrl;return e?u`
      <iframe
        id="embed-iframe"
        src="${e}"
        width="100%"
