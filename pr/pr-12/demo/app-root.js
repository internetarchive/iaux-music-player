...
`;class Wt extends x{static get styles(){return E`
      :host {
        width: var(--iconWidth, 'auto');
        height: var(--iconHeight, 'auto');
      }
    ...
    `}render(){return qt}}customElements.define("ia-icon-texts",Wt);function Yt(){return{el:"#BookReader",showToolbar:!1,onePage:{autofit:"height"},enableFSLogoShortcut:!0,enableBookmarks:!1,enablePageResume:!1,enableTtsPlugin:!1,enableUrlPlugin:!1,defaults:"mode/1up",enableSearch:!0,searchInsideUrl:"/fulltext/inside.php",initialSearchTerm:null,imagesBaseURL:"/bookreader/BookReader/images/",defaultStartLeaf:0,titleLeaf:0,controls:{twoPage:{visible:!1},viewmode:{visible:!1}},bookType:"linerNotes"}}function Zt(r){var e;const i={...r?.brOptions,...Yt()},o=new window.BookReader(i),s=window.BookReader.prototype.getPageURI;o.getPageURI=(d,n=1,f=0)=>{const w=Math.pow(2,Math.floor(Math.log2(Math.max(1,n))));let m=s.call(o,d,w,f);return m+=m.indexOf("?")>-1?"&":"?",m=`${m}scale=${w}&rotate=${f}`,m},window.br=o;const a=(e=r?.data)===null||e===void 0?void 0:e.isRestricted;return window.dispatchEvent(new CustomEvent("contextmenu",{detail:{isRestricted:a}})),o}let $=class extends x{constructor(){super(...arguments),this.showAllPhotos=!1,this.baseHost="archive.org",this.signedIn=!1,this.itemIdentifier="",this.looseImages=[],this.fullscreenActive=!1,this.reInitBrAtFullscreen=!1,this.bindBrEvents=()=>{window.addEventListener("BookReader:PostInit",e=>{var t;console.log("BookReader:PostInit BookReader:PostInit",e,this.bookreader),this.bookreader=(t=e)===null||t===void 0?void 0:t.detail.props,window.br=this.bookreader,setTimeout(()=>{var i,o;(i=this.bookreader)===null||i===void 0||i.jumpToIndex(0),(o=this.bookreader)===null||o===void 0||o.resize(),console.log("POST INIT TIMEOUT RESIZED & JUMPED TO INDEX 00000")},1e3)}),window.addEventListener("BookReader:fullscreenToggled",()=>{var e;this.fullscreenActive=((e=this.bookreader)===null||e===void 0?void 0:e.isFullscreen())||!1})}}firstUpdated(){this.bindBrEvents()}updated(e){var t;e.has("showAllPhotos")&&this.showAllPhotos&&this.linerNotesManifest&&(this.prepareLightDomHook(),this.loadFreshBookReaderFromManifest()),e.has("linerNotesManifest")&&this.linerNotesManifest&&this.loadFreshBookReaderFromManifest(),e.has("looseImages")&&((t=this.looseImages)===null||t===void 0?void 0:t.length)&&this.loadImages()}render(){var e;return console.log("*** RENDER  itemIdentifier ",this.itemIdentifier),((e=this.looseImages)===null||e===void 0?void 0:e.length)===1?h`<img
    ...
    `}get imageBaseUrl(){return`https://${this.baseHost}/download/${this.itemIdentifier}`}prepareLightDomHook(){var e,t;const i=(e=this.lightDomHook)===null||e===void 0?void 0:e.querySelector("div.bookreader-slot");i&&((t=this.lightDomHook)===null||t===void 0||t.removeChild(i))}async loadImages(){}async mountBookReaderLightDomHook(){var e;await new Promise(t=>{var i,o,s;const a=(i=this.lightDomHook)===null||i===void 0?void 0:i.querySelector("div.bookreader-slot");a&&((o=this.lightDomHook)===null||o===void 0||o.removeChild(a));const d=document.createElement("div");d.setAttribute("slot","main"),d.classList.add("bookreader-slot");const n=document.createElement("div");n.classList.add("liner-notes"),d.append(n),(s=this.lightDomHook)===null||s===void 0||s.append(d),n.setAttribute("id","BookReader"),n.classList.add("BookReader"),console.log("~~ bookreaderSlot ",d.offsetHeight,d.offsetWidth),t(!0)}),console.log("~~ async Light dom hook appended",(e=this.lightDomHook)===null||e===void 0?void 0:e.childNodes)}async loadFreshBookReaderFromManifest(){console.log("loadFreshBookReaderFromManifest",this.lightDomHook),await this.mountBookReaderLightDomHook(),setTimeout(()=>{var e;console.log("loading BR Liner Notes"),this.bookreader=this.linerNotesManifest&&Zt(this.linerNotesManifest),(e=this.bookreader)===null||e===void 0||e.init()},0)}get primaryImage(){var e;if(this.linerNotesManifest)return this.linerNotesManifest.brOptions.data.flat()[0].uri;if(!((e=this.looseImages)===null||e===void 0)&&e.length)return`${this.imageBaseUrl}/download/${this.itemIdentifier}/${this.looseImages[0]}`}};$.styles=E`
    :host {
      display: block;
    }
  ...
  `;l([v({type:Boolean,reflect:!0})],$.prototype,"showAllPhotos",void 0);l([v({type:String,attribute:!0,reflect:!0})],$.prototype,"baseHost",void 0);l([v({type:Boolean,reflect:!0})],$.prototype,"signedIn",void 0);l([v({type:String,reflect:!0})],$.prototype,"itemIdentifier",void 0);l([v({type:Object})],$.prototype,"itemMD",void 0);l([v({type:Array})],$.prototype,"looseImages",void 0);l([v({type:Object})],$.prototype,"linerNotesManifest",void 0);l([v({type:Object})],$.prototype,"bookreader",void 0);l([v({type:Boolean,reflect:!0})],$.prototype,"fullscreenActive",void 0);l([v({type:Boolean})],$.prototype,"reInitBrAtFullscreen",void 0);l([v({type:Object})],$.prototype,"lightDomHook",void 0);$=l([L("iaux-photo-viewer")],$);let Me=class extends x{render(){return h`
 ...
 */const Re=Te(class extends Pe{constructor(r){var e;if(super(r),r.type!==mt.ATTRIBUTE||r.name!=="class"||((e=r.strings)===null||e===void 0?void 0:e.length)>2)throw Error("`classMap()` can only be used in the `class` attribute and must be the only part in the attribute.")}render(r){return" "+Object.keys(r).filter(e=>r[e]).join(" ")+" "}update(r,[e]){var t,i;if(this.nt===void 0){this.nt=new Set,r.strings!==void 0&&(this.st=new Set(r.strings.join(" ").split(/\s/).filter(s=>s!=="")));for(const s in e)e[s]&&!(!((t=this.st)===null||t===void 0)&&t.has(s))&&this.nt.add(s);return this.render(e)}const o=r.element.classList;this.nt.forEach(s=>{s in e||(o.remove(s),this.nt.delete(s))});for(const s in e){const a=!!e[s];a===this.nt.has(s)||((i=this.st)===null||i===void 0?void 0:i.has(s))||(a?(o.add(s),this.nt.add(s)):(o.remove(s),this.nt.delete(s)))}return D}});var p;(function(r){r.ia="ia",r.beta="beta",r.youtube="youtube",r.spotify="spotify",r.webamp="webamp"})(p||(p={}));var k;(function(r){r.iaSamples="Samples",r.iaPlayer="Player",r.beta="Beta",r.spotify="Spotify",r.webamp="Webamp",r.youtube="YouTube"})(k||(k={}));const I={ia:h`<img
  ...
  />`},pe=({label:r=k.iaPlayer,selected:e})=>{const i=Be({filter:e?"invert(1)":"invert(0)",height:"20px",width:"20px"}),o=Re({selected:e,"invert-icon-at-hover-selected":e});return h`
...
`,Jt=({samples:r,onClick:e,href:t,selected:i})=>{const o=r?k.iaSamples:k.iaPlayer;return h`
    <a href=${t} @click=${()=>e()}>${pe({label:o,selected:i})}</button>
  `},Kt=({samples:r,onClick:e,selected:t})=>{const i=r?k.iaSamples:k.iaPlayer;return h`
...
`;var ue;(function(r){r.postInit="postInit",r.channelChange="channelChange"})(ue||(ue={}));let S=class extends x{constructor(){super(...arguments),this.youtube=!1,this.spotify=!1,this.beta=!1,this.webamp=!0,this.samples=!1,this.backgroundTheme="dark",this.selected=p.ia,this.displayStyle="radio",this.url=""}firstUpdated(){this.dispatchEvent(new CustomEvent(ue.postInit,{detail:{channel:this.selected},composed:!0,bubbles:!0}))}emitChannelChanged(){this.dispatchEvent(new CustomEvent(ue.channelChange,{detail:{channel:this.selected},composed:!0,bubbles:!0}))}iaClicked(){this.selected!==p.ia&&(this.selected=p.ia,this.emitChannelChanged())}betaClicked(){this.selected!==p.beta&&(this.selected=p.beta,this.emitChannelChanged())}spotifyClicked(){this.selected!==p.spotify&&(this.selected=p.spotify,this.emitChannelChanged())}webampClicked(){this.selected!==p.webamp&&(this.selected=p.webamp,this.emitChannelChanged())}youtubeClicked(){this.selected!==p.youtube&&(this.selected=p.youtube,this.emitChannelChanged())}dropdownOptionSelected(e){this.selected=e.id,this.emitChannelChanged(),this.iaDropdown.open=!1}get iaLinkSelector(){const e=this.selected===p.ia?"selected":"";return h`
    ...
    `:h`<h3>Invalid Spotify URI: ${this.iaSpotifyUrn}</h3>`}static get styles(){return[E`
      ...
      `]}};l([v({type:String,reflect:!0})],X.prototype,"iaSpotifyUrn",void 0);l([v({type:Boolean,reflect:!0})],X.prototype,"display",void 0);l([ce("iframe")],X.prototype,"iframe",void 0);X=l([L("spotify-player")],X);let W=class extends x{constructor(){super(...arguments),this.iaYouTubeUrn="",this.display=!1,this.baseHost="https://archive.org"}get youTubeUrl(){if(!this.iaYouTubeUrn||!this.iaYouTubeUrn.match(/urn:youtube:/g))return"";const t=this.iaYouTubeUrn.replace(/urn:youtube:/g,"").replace(/:/g,"/"),i=`origin=${this.baseHost}&widgetid=1&autoplay=1&rel=0`;return`https://www.youtube.com/embed/${t}?${i}`}render(){const e=this.youTubeUrl;return e?h`
      <iframe
        id="embed-iframe"
        src="${e}"
        width="100%"
