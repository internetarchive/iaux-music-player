...
`;class jt extends ${static get styles(){return C`
      :host {
...
`;class qt extends ${static get styles(){return C`
      :host {
        width: var(--iconWidth, 'auto');
        height: var(--iconHeight, 'auto');
      }
...
`;class Zt extends ${static get styles(){return C`
      :host {
        width: var(--iconWidth, 'auto');
        height: var(--iconHeight, 'auto');
      }
 ...
 */const pi=Te(class extends Pe{constructor(r){super(r),this.et=new WeakMap}render(r){return[r]}update(r,[e]){if(re(this.it)&&(!re(e)||this.it.strings!==e.strings)){const t=tt(r).pop();let i=this.et.get(this.it.strings);if(i===void 0){const o=document.createDocumentFragment();i=lt(g,o),i.setConnected(!1),this.et.set(this.it.strings,i)}et(i,[t]),Qe(i,void 0,t)}if(re(e)){if(!re(this.it)||this.it.strings!==e.strings){const t=this.et.get(e.strings);if(t!==void 0){const i=tt(t).pop();hi(r),Qe(r,void 0,i),et(r,[i])}}this.it=e}else this.it=void 0;return this.render(e)}});let B=class extends ${constructor(){super(...arguments),this.open=!1,this.displayCaret=!1,this.selectedOption="",this.options=[],this.optionGroup="options",this.optionSelected=()=>{}}renderOption(e){const{label:t,url:i=void 0,id:o}=e;let s;const a=this.selectedOption===o?"selected":"";return i?s=u`<a
  ...
  /* End demarcation */
`;var ce;(function(r){r.postInit="postInit",r.channelChange="channelChange"})(ce||(ce={}));let S=class extends ${constructor(){super(...arguments),this.youtube=!1,this.spotify=!1,this.beta=!1,this.webamp=!0,this.samples=!1,this.backgroundTheme="dark",this.selected=p.ia,this.displayStyle="radio",this.url=""}firstUpdated(){this.dispatchEvent(new CustomEvent(ce.postInit,{detail:{channel:this.selected},composed:!0,bubbles:!0}))}emitChannelChanged(){this.dispatchEvent(new CustomEvent(ce.channelChange,{detail:{channel:this.selected},composed:!0,bubbles:!0}))}iaClicked(){this.selected!==p.ia&&(this.selected=p.ia,this.emitChannelChanged())}betaClicked(){this.selected!==p.beta&&(this.selected=p.beta,this.emitChannelChanged())}spotifyClicked(){this.selected!==p.spotify&&(this.selected=p.spotify,this.emitChannelChanged())}webampClicked(){this.selected!==p.webamp&&(this.selected=p.webamp,this.emitChannelChanged())}youtubeClicked(){this.selected!==p.youtube&&(this.selected=p.youtube,this.emitChannelChanged())}dropdownOptionSelected(e){this.selected=e.id,this.emitChannelChanged(),this.iaDropdown.open=!1}get iaLinkSelector(){const e=this.selected===p.ia?"selected":"";return u`
      <li class=${e}>
    ...
    `,vi];l([f({attribute:!0,type:Boolean,reflect:!0})],S.prototype,"youtube",void 0);l([f({attribute:!0,type:Boolean,reflect:!0})],S.prototype,"spotify",void 0);l([f({attribute:!0,type:Boolean,reflect:!0})],S.prototype,"beta",void 0);l([f({attribute:!0,type:Boolean,reflect:!0})],S.prototype,"webamp",void 0);l([f({attribute:!0,type:Boolean,reflect:!0})],S.prototype,"samples",void 0);l([f({attribute:!0,type:String,reflect:!0})],S.prototype,"backgroundTheme",void 0);l([f({type:String,reflect:!0})],S.prototype,"selected",void 0);l([f({type:String,reflect:!0})],S.prototype,"displayStyle",void 0);l([f({type:String})],S.prototype,"url",void 0);l([ue("ia-dropdown")],S.prototype,"iaDropdown",void 0);S=l([L("channel-selector")],S);let Q=class extends ${constructor(){super(...arguments),this.iaSpotifyUrn="",this.display=!1}get spotifyUrl(){return!this.iaSpotifyUrn||!this.iaSpotifyUrn.match(/urn:spotify:/g)?"":`https://open.spotify.com/embed/${this.iaSpotifyUrn.replace(/urn:spotify:/g,"").replace(/:/g,"/")}`}render(){const e=this.spotifyUrl;return e?u`
      <iframe
        id="embed-iframe"
        src="${e}"
        width="100%"
    ...
    `:u`<h3>Invalid Spotify URI: ${this.iaSpotifyUrn}</h3>`}static get styles(){return[C`
      ...
      `]}};l([f({type:String,reflect:!0})],Q.prototype,"iaSpotifyUrn",void 0);l([f({type:Boolean,reflect:!0})],Q.prototype,"display",void 0);l([ue("iframe")],Q.prototype,"iframe",void 0);Q=l([L("spotify-player")],Q);let q=class extends ${constructor(){super(...arguments),this.iaYouTubeUrn="",this.display=!1,this.baseHost="https://archive.org"}get youTubeUrl(){if(!this.iaYouTubeUrn||!this.iaYouTubeUrn.match(/urn:youtube:/g))return"";const t=this.iaYouTubeUrn.replace(/urn:youtube:/g,"").replace(/:/g,"/"),i=`origin=${this.baseHost}&widgetid=1&autoplay=1&rel=0`;return`https://www.youtube.com/embed/${t}?${i}`}render(){const e=this.youTubeUrl;return e?u`
      <iframe
        id="embed-iframe"
        src="${e}"
        width="100%"
