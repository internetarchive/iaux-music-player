...
`;class Zt extends k{static get styles(){return M`
    ...
    `}async loadImages(){}handleBrPostInit(e){var t;this.bookreader=(t=e)===null||t===void 0?void 0:t.detail.props,window.br=this.bookreader,setTimeout(()=>{var i,o;(i=this.bookreader)===null||i===void 0||i.jumpToIndex(0),(o=this.bookreader)===null||o===void 0||o.resize()},1e3)}prepareLightDomHook(){var e,t;const i=(e=this.lightDomHook)===null||e===void 0?void 0:e.querySelector("div.bookreader-slot");i&&((t=this.lightDomHook)===null||t===void 0||t.removeChild(i))}async loadFreshBookReaderFromManifest(){await this.mountBookReaderLightDomHook(),await new Promise(e=>{setTimeout(()=>{var t;this.bookreader=this.linerNotesManifest&&Kt(this.linerNotesManifest),(t=this.bookreader)===null||t===void 0||t.init(),e()},0)})}async mountBookReaderLightDomHook(){await new Promise(e=>{var t,i,o;const s=(t=this.lightDomHook)===null||t===void 0?void 0:t.querySelector("div.bookreader-slot");s&&((i=this.lightDomHook)===null||i===void 0||i.removeChild(s));const a=document.createElement("div");a.setAttribute("slot","main"),a.classList.add("bookreader-slot");const d=document.createElement("div");d.classList.add("liner-notes"),a.append(d),(o=this.lightDomHook)===null||o===void 0||o.append(a),d.setAttribute("id","BookReader"),d.classList.add("BookReader"),e(!0)})}};$.styles=M`
    :host {
      display: block;
    }
